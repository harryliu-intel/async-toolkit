...
mby_igr_top igr_top_i (
   .cclk(ingress_clock),
   .rst(ingress_reset),
   .grp_a_rx_ecc(eth_bfm_rx_intf_0.ecc),
   .grp_b_rx_ecc(eth_bfm_rx_intf_1.ecc),
   .grp_c_rx_ecc(eth_bfm_rx_intf_2.ecc),
   .grp_d_rx_ecc(eth_bfm_rx_intf_3.ecc),
   ...
   .grp_a_rx_data_w_ecc(eth_bfm_rx_intf_0.data_w_ecc),
   .grp_b_rx_data_w_ecc(eth_bfm_rx_intf_1.data_w_ecc),
   ...
   .grp_b_rx_flow_control_tc(eth_bfm_rx_intf_1.flow_control_tc),
   .grp_c_rx_flow_control_tc(eth_bfm_rx_intf_2.flow_control_tc),
   .grp_d_rx_flow_control_tc(eth_bfm_rx_intf_3.flow_control_tc),
   .vp_rx_ecc(eth_bfm_rx_intf_4.ecc),
   ...
   .vp_rx_data_w_ecc(eth_bfm_rx_intf_4.data_w_ecc),
