...
# DVE full session
# Saved on Sun Nov 4 18:21:00 2018
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/nfs/sc/disks/slx_1130/edwardro/mby/work_root/mby.edr.1/subBlock/mbyc/src/igr/sandbox/edrsim/shim.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{58 419} {2852 1457}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 818]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 818
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 817} {height 746} {dock_state left} {dock_on_new_line true} {child_hier_colhier 683} {child_hier_coltype 127} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 337} {height 746} {dock_state left} {dock_on_new_line true} {child_data_colvariable 204} {child_data_colvalue 56} {child_data_coltype 76} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 2794} {height 174} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{4 25} {2247 969}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 831} {child_wave_right 1407} {child_wave_colname 306} {child_wave_colvalue 522} {child_wave_col1 0} {child_wave_col2 1}}
...
# Global: Highlighting
gui_highlight_signals -color #00ff00 {{TB_IGR_TOP.top.igr_pb.pb_ctrl_p0.pb_shell_ctrl_wdata[0]} {TB_IGR_TOP.top.igr_pb.pb_ctrl_p0.pb_shell_ctrl_wdata[0].rd_en} {TB_IGR_TOP.top.igr_pb.pb_ctrl_p0.pb_shell_ctrl_wdata[3:0]} {TB_IGR_TOP.top.dpc_wrap.dpc_0.qs1_rx_port_num[1:0]}}
...
gui_marker_create -id ${Wave.1} C2 266
gui_marker_select -id ${Wave.1} {  C2 }
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 254 266
...
gui_list_expand -id ${Wave.1} TB_IGR_TOP.top.epl_shim_0.segs0.i_seg0_md
gui_list_expand -id ${Wave.1} TB_IGR_TOP.top.epl_shim_0.segs0.seg0.s4q_rx_data_seg
gui_list_expand -id ${Wave.1} TB_IGR_TOP.top.epl_shim_0.segs0.seg0.rx_data_seg
gui_list_expand -id ${Wave.1} TB_IGR_TOP.top.epl_shim_0.segs0.seg0.i_seg_we
gui_list_expand -id ${Wave.1} TB_IGR_TOP.top.epl_shim_0.segs0.seg0.i_seg_sel
gui_list_select -id ${Wave.1} {{TB_IGR_TOP.top.epl_shim_0.segs0.seg0.rx_data_seg[7]} }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group2  -item {TB_IGR_TOP.top.epl_shim_0.segs0.seg0.i_seg_sel.s0[3:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 264
gui_view_scroll -id ${Wave.1} -vertical -set 4385
