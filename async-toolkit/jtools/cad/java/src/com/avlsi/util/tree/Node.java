...
public class Node<T> {
    ...
    /**
     * Gets the parent of a Node<T> object. 
     * @return parent of Node<T>.
     */
    ...
    /**
     * Gets all parents of a Node<T> object. 
     * @return list of parents of Node<T>.
     */
     ...
     * Note that each Node can have only one parent.
     * @param parent Node<T> to set.
     */
