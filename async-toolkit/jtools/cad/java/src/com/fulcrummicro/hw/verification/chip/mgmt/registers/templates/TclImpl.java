...
static final int __TCL_INDENT = 4;
    ...
    throws java.io.IOException
  {
    ...
    for (Register r : regs )
    {
      ...
      {
        // 231, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), "namespace export", __indent , 1, null);
      }
      // 231, 84
      jamonWriter.write("\n");
    }
    ...
    for (RegisterBase b : bases )
    {
      ...
      {
        // 242, 1
        __jamon_innerUnit____decl(jamonWriter, b.getFullName(), "variable", __indent , __DECL_BASE_WIDTH, null);
      }
      // 242, 96
      jamonWriter.write(" ");
      // 243, 1
...
boolean w = r.getEntryWidth() > 1;
      ...
      {
        // 261, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", __indent , __DECL_DEFAULT_WIDTH, "_BITS");
      }
      // 261, 87
      jamonWriter.write(" ");
      // 262, 1
      ...
      {
        // 264, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", __indent , __DECL_DEFAULT_WIDTH, "_DEFAULT");
      }
      // 264, 90
      jamonWriter.write(" ");
      // 265, 1
      ...
      {
        // 267, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", __indent , __DECL_DEFAULT_WIDTH, "_NDIMS");
      }
      // 267, 88
      jamonWriter.write(" ");
      // 268, 1
      ...
      {
        // 270, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", __indent , __DECL_DEFAULT_WIDTH, "_WIDTH");
      }
      // 270, 88
      jamonWriter.write(" ");
      // 271, 1
      ...
      if (nDims == 0 )
      {
        ...
        {
          // 274, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "proc", __indent , __DECL_DEFAULT_WIDTH, w ? " {{word}}" : " {}");
        }
        // 274, 99
        jamonWriter.write(" { ");
        // 275, 3
        {
          // 275, 3
          __jamon_innerUnit____decl(jamonWriter, r.getBaseName(), "variable", null , 1, null);
        }
        // 275, 78
      ...
      else if (nDims == 1 )
      {
        ...
        {
          // 278, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "proc", __indent , __DECL_DEFAULT_WIDTH, w ? " {{index} {word}}" : " {{index}}");
        }
        // 278, 114
        jamonWriter.write(" { ");
        // 279, 3
      ...
      else if (nDims == 2 )
      {
        ...
        {
          // 283, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "proc", __indent , __DECL_DEFAULT_WIDTH, w ? " {{index1} {index0} {word}}" : " {{index1} {index0}}");
        }
        // 283, 134
        jamonWriter.write(" { ");
        // 284, 3
      ...
      else if (nDims == 3 )
      {
        ...
        {
          // 289, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "`define", __indent , __DECL_DEFAULT_WIDTH, w ? " {{index2} {index1} {index0} {word}}" : " {{index2} {index1} {index0}}");
        }
        // 289, 155
        jamonWriter.write(" { ");
        // 290, 3
...
for (int j = 0; j < w; j++) {
    ...
    throws java.io.IOException
  {
    ...
    for (ConstantsEnumValue c : e.values )
    {
      ...
      {
        // 72, 1
        __jamon_innerUnit____decl(jamonWriter, c.getVerilogName().toUpperCase(), "variable", __indent, __DECL_BASE_WIDTH , null);
      }
      // 72, 99
      jamonWriter.write(" ");
      // 73, 1
...
Collection<RegisterField> fields = r.getSortedFields(false, true, false, false);
    ...
    for (RegisterField f : fields )
    {
      ...
      if (f.len == 1 )
      {
        ...
        {
          // 93, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", i , __DECL_DEFAULT_WIDTH, "_b_" + f.desc);
        }
        // 93, 87
        jamonWriter.write(" ");
        // 94, 1
      ...
      else
      {
        ...
        {
          // 96, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", i , __DECL_DEFAULT_WIDTH, "_l_" + f.desc);
        }
        // 96, 87
        jamonWriter.write(" ");
        // 97, 1
        ...
        {
          // 98, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", i , __DECL_DEFAULT_WIDTH, "_h_" + f.desc);
        }
        // 98, 87
        jamonWriter.write(" ");
        // 99, 1
        ...
        if (f.entries > 1 )
        {
          ...
          {
            // 101, 1
            __jamon_innerUnit____decl(jamonWriter, r.getName(), "variable", i , __DECL_DEFAULT_WIDTH, "_s_" + f.desc);
          }
          // 101, 87
          jamonWriter.write(" ");
          // 102, 1
  ...
  // 40, 1
  private void __jamon_innerUnit____decl(final java.io.Writer jamonWriter, final String name, final String keyword, final StringBuilder i, final int w, final String suffix)
    throws java.io.IOException
  {
    // 48, 1
