...
FV_PERL_WIDTH += prefix.length() + 3;
      ...
      {
        // 502, 6
        __jamon_innerUnit____wstrfname(jamonWriter, b.getName(), FV_PERL_WIDTH, "_SIZE" );
      }
      // 502, 61
      jamonWriter.write(" = ");
      // 503, 1
...
String name = Utility.possibleUnderscoreToLowerCase(e.getName()).toUpperCase();
          ...
          {
            // 523, 5
            __jamon_innerUnit____wstrfname(jamonWriter, name, FV_PERL_WIDTH, "__" + value.getName() );
          }
          // 523, 68
...
boolean md = r.getNumEntries1() > 1;
    ...
    if (r.getNumEntries() > 1 )
    {
      ...
      {
        // 207, 6
        __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_STRIDE" + (md ? "_0" : "") );
      }
      // 207, 82
      jamonWriter.write(" = ");
      // 208, 1
    ...
    if (r.getNumEntries1() > 1 )
    {
      ...
      {
        // 211, 6
        __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_STRIDE_1" );
      }
      // 211, 65
      jamonWriter.write(" = ");
      // 212, 1
    ...
    if (r.getNumEntries2() > 1 )
    {
      ...
      {
        // 215, 6
        __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_STRIDE_2" );
      }
      // 215, 65
      jamonWriter.write(" = ");
      // 216, 1
...
throw new Error(nDims + "-dimensional registers not supported");
  ...
  // 262, 1
  private void __jamon_innerUnit____wstrfname(final java.io.Writer jamonWriter, final String name, final int w, final String suffix)
    throws java.io.IOException
  {
    // 268, 1
...
String format = w >= 0 ? String.format("%%-%ds", w) : "%s";
    ...
    throws java.io.IOException
  {
    ...
    for (RegisterField f : r.fields.values() )
    {
      ...
      if (f.len == 1 )
      {
        ...
        {
          // 97, 6
          __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_b_" + f.desc );
        }
        // 97, 68
        jamonWriter.write(" = ");
        // 98, 1
      ...
      else
      {
        ...
        {
          // 100, 6
          __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_l_" + f.desc );
        }
        // 100, 68
        jamonWriter.write(" = ");
        // 101, 1
        ...
        {
          // 102, 6
          __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_h_" + f.desc );
        }
        // 102, 68
        jamonWriter.write(" = ");
        // 103, 1
    ...
    throws java.io.IOException
  {
    ...
    {
      // 238, 6
      __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_WIDTH" );
    }
    // 238, 62
    jamonWriter.write(" = ");
    // 239, 1
    ...
    {
      // 240, 6
      __jamon_innerUnit____wstrfname(jamonWriter, r.getName(), FV_PERL_WIDTH, "_BITS" );
    }
    // 240, 61
    jamonWriter.write(" = ");
    // 241, 1
    ...
    throws java.io.IOException
  {
    ...
    {
      // 183, 1
      __jamon_innerUnit____wstrfname(jamonWriter, name, -1 , suffix);
    }
  }
