...
fm_status fmAllocateMacTablePurgeList(fm_switch* switchPtr)
{
    ...
    purgePtr               = &switchPtr->maPurge;
    purgePtr->active       = FM_PURGE_STATE_IDLE;
 ...
 *                  immediately.
 *                                                                      \lb\lb
 *                  If multiple requests with the same parameters are
 *                  enqueued, they will be coalesced into a single request.
 *                  The following table lists the operations that will occur
 *                  based on the request and existing entries:
 * 
 ...
 * caseId  workType                               entries)        new entry)
 * ------  -------------------------------------  --------------  --------------
 * 0       FM_UPD_FLUSH_DYN_ADDRESSES             -               Impossible
 * 1       FM_UPD_FLUSH_DYN_ADDRESSES             port            -
 * 2       FM_UPD_FLUSH_DYN_ADDRESSES             vlan            -
 * 3       FM_UPD_FLUSH_DYN_ADDRESSES             port/vlan       -
 * 4       FM_UPD_FLUSH_DYN_ADDRESSES             port/vid1/vid2  -
 * 5       FM_UPD_FLUSH_DYN_ADDRESSES             port/vid2       -
 * 6       FM_UPD_FLUSH_DYN_ADDRESSES             vid1/vid2       -
 * 7       FM_UPD_FLUSH_DYN_ADDRESSES             vid2            -
 * 40      FM_UPD_FLUSH_DYN_ADDRESSES             port/vid1/remId -
 * 49      FM_UPD_FLUSH_DYN_ADDRESSES             vid1/remId      -
 * 50      FM_UPD_FLUSH_DYN_ADDRESSES             remId           -
 * ------  -------------------------------------  --------------  --------------
 * 8       FM_UPD_FLUSH_PORT_ADDRESSES            -               dynamic
 * 9       FM_UPD_FLUSH_PORT_ADDRESSES            port/vlan       -
 * 10      FM_UPD_FLUSH_PORT_ADDRESSES            port/vid1/vid2  -
 * 11      FM_UPD_FLUSH_PORT_ADDRESSES            port/vid2       -
 * 41      FM_UPD_FLUSH_PORT_ADDRESSES            port/vid1/remId -
 * ------  -------------------------------------  --------------  --------------
 * 12      FM_UPD_FLUSH_VLAN_ADDRESSES            -               dynamic
 * 13      FM_UPD_FLUSH_VLAN_ADDRESSES            port/vlan       -
 * 14      FM_UPD_FLUSH_VLAN_ADDRESSES            port/vid1/vid2  -
 * 15      FM_UPD_FLUSH_VLAN_ADDRESSES            vid1/vid2       -
 * 42      FM_UPD_FLUSH_VLAN_ADDRESSES            port/vid1/remId -
 * 51      FM_UPD_FLUSH_VLAN_ADDRESSES            vid1/remId      -
 * ------  -------------------------------------  --------------  --------------
 * 16      FM_UPD_FLUSH_PORT_VLAN_ADDRESSES       -               dynamic
 * 17      FM_UPD_FLUSH_PORT_VLAN_ADDRESSES       -               port
 * 18      FM_UPD_FLUSH_PORT_VLAN_ADDRESSES       -               vlan
 * 19      FM_UPD_FLUSH_PORT_VLAN_ADDRESSES       port/vid1/vid2  -
 * 43      FM_UPD_FLUSH_PORT_VLAN_ADDRESSES       port/vid1/remId -
 * ------  -------------------------------------  --------------  --------------
 * 20      FM_UPD_FLUSH_VID1_VID2_ADDRESSES       -               dynamic
 * 21      FM_UPD_FLUSH_VID1_VID2_ADDRESSES       -               vlan
 * 22      FM_UPD_FLUSH_VID1_VID2_ADDRESSES       -               vid2
 * 23      FM_UPD_FLUSH_VID1_VID2_ADDRESSES       port/vid1/vid2  -
 * ------  -------------------------------------  --------------  --------------
 * 24      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               dynamic
 * 25      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               port
 * 26      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               vlan
 * 27      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               vid2
 * 28      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               port/vlan
 * 29      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               port/vid2
 * 30      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  -               vid1/vid2
 * 31      FM_UPD_FLUSH_PORT_VID1_VID2_ADDRESSES  Impossible      -
 * ------  -------------------------------------  --------------  --------------
 * 32      FM_UPD_FLUSH_PORT_VID2_ADDRESSES       -               dynamic
 * 33      FM_UPD_FLUSH_PORT_VID2_ADDRESSES       -               port
 * 34      FM_UPD_FLUSH_PORT_VID2_ADDRESSES       -               vid2
 * 35      FM_UPD_FLUSH_PORT_VID2_ADDRESSES       port/vid1/vid2  -
 * ------  -------------------------------------  --------------  --------------
 * 36      FM_UPD_FLUSH_VID2_ADDRESSES            -               dynamic
 * 37      FM_UPD_FLUSH_VID2_ADDRESSES            port/vid2       -
 * 38      FM_UPD_FLUSH_VID2_ADDRESSES            port/vid1/vid2  -
 * 39      FM_UPD_FLUSH_VID2_ADDRESSES            vid1/vid2       -
 * ------  -------------------------------------  --------------  --------------
 * 44      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               dynamic
 * 45      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               port
 * 46      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               vlan
 * 47      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               port/vlan
 * 59      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               vid1/remId
 * 60      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  -               remId
 * 48      FM_UPD_FLUSH_PORT_VID1_REMOTEID_ADDRESSES  Impossible      -
 * ------  -------------------------------------  --------------  --------------
 * 52      FM_UPD_FLUSH_VID1_REMOTEID_ADDRESSES   -               dynamic
 * 53      FM_UPD_FLUSH_VID1_REMOTEID_ADDRESSES   -               vlan
 * 54      FM_UPD_FLUSH_VID1_REMOTEID_ADDRESSES   -               remoteId
 * 55      FM_UPD_FLUSH_VID1_REMOTEID_ADDRESSES   port/vid1/remId -
 * ------  -------------------------------------  --------------  --------------
 * 56      FM_UPD_FLUSH_REMOTEID_ADDRESSES        -               dynamic
 * 57      FM_UPD_FLUSH_REMOTEID_ADDRESSES        port/vid1/remId -
 * 58      FM_UPD_FLUSH_REMOTEID_ADDRESSES        vid1/remId -
 * ------  -------------------------------------  --------------  --------------
 * 
 * \param[in]       sw is the switch on which to operate.
 *
                                       ...
                                       fm_maPurgeListEntry *purgeEntry)
{
    ...
    if ((purgeEntry->port != -1) && !purgeEntry->portExists )
    {
            ...
            fmTreeSize(&purgeEntry->remoteIdTree) == 0)
        {
             ...
             * maPurge.globalListEntry is always the first on t
             * he list. 
             **************************************************/
...
fm_status fmCommonDumpPurgeStats(fm_int sw)
{
    ...
    FM_LOG_PRINT("   Purge requests written to hardware:\n");
    
    if ( (switchPtr->switchFamily == FM_SWITCH_FAMILY_FM4000) ||
    ...
    FM_LOG_PRINT("   Purge requests written to hardware that completed:\n");
 ...
 * \chips           FM3000, FM4000, FM6000
 *
 * \desc            Reset MA Table purge diagnostic statistics.
 *
 * \param[in]       sw is the switch on which to operate.
 *
 * \return          FM_OK unconditionally
