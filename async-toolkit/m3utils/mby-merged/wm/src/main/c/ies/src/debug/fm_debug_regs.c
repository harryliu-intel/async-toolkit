                           ...
                           fm_voidptr callbackInfo)
{
    ...
    snprintf(regTitle, sizeof(regTitle),
...
fm_status fmTestReadRegister(fm_int sw, fm_uint offset, fm_uint32 *pVal)
{
    ...
    if (fmRootApi->fmSwitchStateTable[sw]->ReadUncacheUINT32)
    {
        /* When caching is enabled, use this to read uncached value */
        return (fmRootApi->fmSwitchStateTable[sw]->ReadUncacheUINT32(sw, offset, pVal));
    }
    
    return (fmRootApi->fmSwitchStateTable[sw]->ReadUINT32(sw, offset, pVal));
...
fm_status fmTestRead64BitRegister(fm_int sw, fm_uint offset, fm_uint64 *pVal)
{
    ...
    if (fmRootApi->fmSwitchStateTable[sw]->ReadUncacheUINT64)
    {
        /* When caching is enabled, use this to read uncached value */
        return (fmRootApi->fmSwitchStateTable[sw]->ReadUncacheUINT64(sw, offset, pVal));
    }

    return (fmRootApi->fmSwitchStateTable[sw]->ReadUINT64(sw, offset, pVal));
