...
/**
 * Negate expression, represents <code> - x </code>.
 *
 * @author Jesse Rosenstock
 * @version $Revision$ $Date$
 **/
public class NegateExpression extends AbstractUnaryExpression {
     ...
     **/
    public NegateExpression(final ExpressionInterface expr) {
        super(expr);
    }
