...
// This is a local version based on the code by Pierre-Luc Paour.  The original
...
public class NaturalStringComparator implements Comparator<Object> {
    ...
    private static NaturalStringComparator singleton = null;

    public static NaturalStringComparator getInstance() {
        if (singleton == null) {
            singleton = new NaturalStringComparator();
        }
        return singleton;
    }
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(scrambled, getInstance());
