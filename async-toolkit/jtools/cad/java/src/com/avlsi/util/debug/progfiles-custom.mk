...
# $Id: //depot/sw/cad/java/main/src/com/avlsi/util/readline/progfiles-custom.mk#2 $
# $DateTime: 2004/11/01 11:51:02 $
# $Author: aubrey $
...
MAKE_LINK_RULE_TARGET_NAME := libGetTime.so
MAKE_LINK_RULE_TARGET_DEPENDENCIES := $(CURR_TARGET_DIR)/GetTime.o
