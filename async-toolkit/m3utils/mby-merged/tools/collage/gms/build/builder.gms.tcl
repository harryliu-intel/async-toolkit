...
set ::collage_ip_info::ip_rtl_inc_dirs "$::env(MODEL_ROOT)/subBlock/mbyc/src/gmm/gms/rtl $::env(MODEL_ROOT)/target/mby/mgm_run/igr/src $::env(MODEL_ROOT)/target/mby/mgm_run/rtl $::env(MODEL_ROOT)/target/mby/mgm_run/igr_pbb/src"
