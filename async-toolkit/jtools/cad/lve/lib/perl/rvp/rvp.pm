...
#
# File:         rvp.pm
# RCS:          $Header: rvp.pm,v 7.60 2006/01/12 10:45:41 cc Exp $
...
use vars qw(@verilog_gatetype_keywords $verilog_gatetype_regexp 
	    ...
	    @verilog_signal_keywords $verilog_sigs_regexp $quiet $debug $VID $HVID $VNUM
	    $takenArcs
...
BEGIN {
    ...
    $version = '$Header: rvp.pm,v 7.60 2006/01/12 10:45:41 cc Exp $'; #'
    $version =~ s/^\S+ \S+ (\S+) .*$/$1/;
    $VERSION = $version; 
