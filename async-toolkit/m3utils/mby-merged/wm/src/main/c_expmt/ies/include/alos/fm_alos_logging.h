...
/** Packet tranmsmission event handling. */
...
/** MACsec model */
#define FM_LOG_CAT_MODEL_MACSEC       (FM_LITERAL_U64(1) << 13)
...
/** Parser model */
#define FM_LOG_CAT_MODEL_PARSER       (FM_LITERAL_U64(1) << 20)

/** Mapper model */
#define FM_LOG_CAT_MODEL_MAPPER       (FM_LITERAL_U64(1) << 21)

/** FFU classifier and final actions models */
#define FM_LOG_CAT_MODEL_FFU          (FM_LITERAL_U64(1) << 22)

/** Next Hop model */
#define FM_LOG_CAT_MODEL_NEXT_HOP     (FM_LITERAL_U64(1) << 23)

/** L2 Lookup model */
#define FM_LOG_CAT_MODEL_L2_LOOKUP    (FM_LITERAL_U64(1) << 24)

/** Genmask model */
#define FM_LOG_CAT_MODEL_GEN_MASK      (FM_LITERAL_U64(1) << 25)

/** API Link-Aggregation. */
#define FM_LOG_CAT_LAG                (FM_LITERAL_U64(1) << 26)

/** Glort model */
#define FM_LOG_CAT_MODEL_GLORT        (FM_LITERAL_U64(1) << 27)

/** triggers model */
#define FM_LOG_CAT_MODEL_TRIGGERS     (FM_LITERAL_U64(1) << 28)

/** Link-state debouncing events */
#define FM_LOG_CAT_EVENT_PORT         (FM_LITERAL_U64(1) << 29)

/** Modify model */
#define FM_LOG_CAT_MODEL_MODIFY       (FM_LITERAL_U64(1) << 30)

/** MAC model */
#define FM_LOG_CAT_MODEL_MAC            (FM_LITERAL_U64(1) << 31)

/** Interrupt task handling */
#define FM_LOG_CAT_EVENT_INTR         (FM_LITERAL_U64(1) << 32)

/** RX Stats model */
#define FM_LOG_CAT_MODEL_STATS        (FM_LITERAL_U64(1) << 33)

/** RBrdige */
#define FM_LOG_CAT_RBRIDGE            (FM_LITERAL_U64(1) << 34)

/** API attribute subsystem */
...
/** Switch device strom controller management */
...
/** Learning model */
#define FM_LOG_CAT_MODEL_LEARNING     (FM_LITERAL_U64(1) << 63)
 ...
 * most common calls to ''fmLogMessage''.
 *                                                                      \lb\lb
...
#endif  /* FM_ALOS_FUNCTION_LOGGING */

#endif  /* FM_ALOS_LOGGING_SUBSYSTEM */
...
/***************************************************************************/
/** Verbose Log exit from a function. Used wherever a function exits but has no
 *  return type
 *                                                                      \lb\lb
 * This macro should be used where a void return statement would normally
 * appear. When the ''FM_LOG_LEVEL_FUNC_EXIT'' log level is enabled, this macro
