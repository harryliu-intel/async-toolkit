...
object ParserProgrammer {
  ...
  val lens_MBY_PARSER_PORT_CFG_3 = parser_port_cfg_r.state
  ...
  val lens_MBY_PARSER_KEY_W_5 = parser_key_w_r.state
  ...
  val lens_MBY_PARSER_KEY_S_5 = parser_key_s_r.state
  ...
  val lens_MBY_PARSER_ANA_W_5 = parser_ana_w_r.state
  ...
  val lens_MBY_PARSER_ANA_S_5 = parser_ana_s_r.state
  ...
  val lens_MBY_PARSER_EXC_5 = parser_exc_r.state
  ...
  val lens_MBY_PARSER_EXT_5 = parser_ext_r.state
