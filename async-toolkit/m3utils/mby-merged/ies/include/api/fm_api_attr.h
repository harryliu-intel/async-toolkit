...
enum _fm_switchAttr
{
    ...
    /** Type fm_int: Indicates the disposition for frames received with 
     *  a DMAC matching the MAC configured via FM_CPU_MAC.  Valid values
     *  are FM_CPU_MAC_TRAP_DISP_AFTER_IBV_CHECK (default) and
     ...
     *                                                                  \lb\lb
     *  For FM3000, FM4000, the API attribute ''api.FM4000.enableVidAsFid''
     ...
     *  
     *  For FM6000 devices, the frames will be dropped if the MAC
     *  matches 01-80-c2-00-00-01 OR if the Ethertype matches 8808.
     *
     *  \chips  FM2000, FM3000, FM4000, FM6000*/
    FM_DROP_PAUSE,

    /** Type fm_int: Broadcast flooding control. Value is:                  
     *                                                                  \lb\lb
     ...
     *                                                                  \lb\lb
     *  For FM6000 devices, use ''FM_FRAME_AGING_TIME_MSEC''.
     *
     *  \chips  FM2000, FM3000, FM4000 */
    FM_FRAME_AGING_TIME,
     ...
     *  and FM4000, this is the EBI clock, for FM6000, this is the PCIE clock).
     *                                                                  \lb\lb
     ...
     *                                                                  \lb\lb
     *  For FM6000:                                                     \lb
     *  125Mhz => default: 0 ms, max: 4,398,046 ms;
     *
     *  \chips  FM2000, FM3000, FM4000, FM6000 */
     ...
     *                                                                  \lb\lb
     *  Configures hashing of L3/L4 headers for
     *  ECMP and LAG. The following bits may be ORed together to define the
     *  hashing algorithm:
     *                                                                  \lb\lb
    ...
    /** Type fm_uint32: Deprecated - Use ''FM_L3_HASH_CONFIG'' instead.
     *                                                                  \lb\lb
     *  Represents the value used for the hash rotation portion
     *  of the routing hash.  For FM3000 and FM4000 devices, this attribute
     *  specifies one of three 12-bit hash rotations for use in ECMP binning. 
     *  The attribute value may range from 0 to 2 with a default value of 0. 
     *
     *  \chips  FM3000, FM4000 */
    ...
    /** Type fm_uint32: Deprecated - Use ''FM_L3_HASH_CONFIG'' instead.
     *                                                                  \lb\lb
     *  When the FM_ROUTING_HASH_PROT1 bit of
     *  the ''FM_ROUTING_HASH'' attribute is set, the layer 4 source and 
     *  destination will contribute to the hash only if the frame's protocol 
     *  field matches the value of this attribute. The attribute value ranges 
     *  from 0 to 255 with a default value of 1. 
     *
     *  \chips  FM3000, FM4000 */
    FM_ROUTING_HASH_PROT_1,

    /** Type fm_uint32: Deprecated - Use ''FM_L3_HASH_CONFIG'' instead.
     *  When the FM_ROUTING_HASH_PROT2 bit of
     *  the ''FM_ROUTING_HASH'' attribute is set, the layer 4 source and 
     *  destination will contribute to the hash only if the frame's protocol 
     *  field matches the value of this attribute. The attribute value ranges 
     *  from 0 to 255 with a default value of 1. 
    ...
    /** Type fm_int: Indicates the disposition for IP frames
     ...
     *                                                                  \lb\lb
     *  For FM3000 and FM4000: The API attribute ''api.FM4000.enableVidAsFid''
     *  must be set to TRUE in order for any of the TRAP values for this
     *  attribute to work properly.
     *  
     *  For FM6000: The values may be OR'ed together to obtain
     *  combined trapping/logging.
     *
     *  \chips  FM3000, FM4000, FM6000 */
    FM_IP_OPTIONS_DISPOSITION,

    /** Type fm_uint32: A mask indicating which 
     *  statistic groups are enabled for counting.  Value is a mask of the 
     *  following constants:
     *                                                                  \lb\lb
    ...
    /** Type ''fm_LBGMode'':  Indicates which load balancing group mode to use. 
     *  Note that this mode can be overridden on a per load balancing group
     *  basis when the LBG is created with ''fmCreateLBGExt''.
     *
     *  \chips  FM3000, FM4000, FM6000 */
    FM_LBG_MODE,

    /** Type fm_int:  Indicates which logical port
     *  to redirect CPU traffic to. The logical port can be a phyical
     *  port or a LAG port.
     *                                                                  \lb\lb
     ...
     *  ''API Attributes''.  These attributes are listed for each structure 
     ...
     *                                                                  \lb\lb
     *  In many cases, this attribute can be changed on-the-fly without 
     *  disrupting traffic. The API will reposition the boundary between ACLs
     *  and routes or relocate routes automatically unless there is no way 
     *  for it to do so, in which case ''fmSetSwitchAttribute'' will return 
     *  an error code. In such a case, the application must take the 
     *  following steps to effect the change:
     *                                                                  \lb\lb
     ...
     *  4. Set this attribute to the new allocation.                        \lb
     ...
     *  API attribute is not set to TRUE.*/
     ...
     *  encapsulated frame. Default to 0x22F3 as assigned by the
    ...
    /** Type fm_ipAddr: Defines the VxLan Destination IP address.
     *
     * \chips FM6000 */
    FM_SWITCH_VXLAN_DIP,

    /** Type fm_uint32: Defines the destination port used by
     *  tunneling protocol (such VxLAN and GRE) in an UDP header.
     *  (Default value is 0x2118).
     *
     * \chips FM6000 */
    ...
    /** Type fm_bool: Whether to parse the Virtual Network endpoint tag:
 ...
 * Depreacted, always assume 802.1Q.
 **************************************************/
...
{
    /** Identifies one of MTU entries. Values may range from 0 to TBD. */
    fm_uint index;
 ...
 **************************************************/
#define FM_ETH_MODE_ENABLED_BIT_MASK    0x10000
#define FM_ETH_MODE_4_LANE_BIT_MASK     0x20000
#define FM_ETH_MODE_40G_BIT_MASK        0x40000
...
enum _fm_vlanAttr
{
     ...
     *  identical to setting the ''FM_VLAN_ROUTING_REFLECT'' and
    ...
    /** Type fm_int: Indicates which MTU value to use for this 
    ...
    /** Type fm_bool: Defines if IGMP frames are trapped or not
     *  on this VLAN.  Set to FM_ENABLED to enable IGMP trappng and
     *  FM_DISABLED (default) to disable trapping.
     *                                                                  \lb\lb
    ...
    /** Type fm_bool: Defines if FID2 must be part of the MAC lookup on this
     *  VLAN.  Set to FM_ENABLED to enable FID2 matching and
     *  FM_DISABLED (default) to disable it.
     *
     *  \chips  FM6000 */
    FM_VLAN_FID2_IVL,

    /** Type: fm_bool. Enables ARP frames trapping.
     *  This attribute has been deprecated in favor of the
     * ''FM_VLAN_ARP_LOGGING'' attribute 
     *
     * \chips FM6000 */
    FM_VLAN_ARP_TRAPPING,

    /** Type fm_bool: Defines if unknown unicast frames are flooded or not
     *  on this VLAN.  Set to FM_ENABLED to enable flooding and
     *  FM_DISABLED (default) to disable flooding.
     *
     *  \chips  FM6000 */
...
enum _fm_maTableAttr
{
     ...
     *                                                                  \lb\lb
     *  For FM6000 devices, use ''TBD''.
     *
     *  \chips  FM2000, FM3000, FM4000 */
    FM_MAC_TABLE_HASH_POLYNOMIAL,

    /** (Deprecated).  Please see ''FM_MAC_TABLE_HASH_POLYNOMIAL'',
     *  which functions identically to this attribute. 
     *  \chips  (None) */
    FM_HASH_POLYNOMIAL,
    ...
    /** (Deprecated).  Please see ''FM_MAC_TABLE_SA_LOOKUP_MODE'', which 
    ...
    /** (Deprecated).  Please see ''FM_MAC_TABLE_ADDRESS_AGING_TIME'', which
     *  functions identically to this attribute. 
     *  \chips  (None) */
...
#define FM_HASH_POLYNOMIAL_0                 FM_MAC_TABLE_HAS_POLYNOMIAL_0
#define FM_HASH_POLYNOMIAL_1                 FM_MAC_TABLE_HAS_POLYNOMIAL_1
#define FM_HASH_POLYNOMIAL_2                 FM_MAC_TABLE_HAS_POLYNOMIAL_2
#define FM_HASH_POLYNOMIAL_3                 FM_MAC_TABLE_HAS_POLYNOMIAL_3
 ...
 * indicated.
 *                                                                      \lb\lb
 * Unless otherwise indicated, attributes are not applicable to the CPU
 * interface port.
 *                                                                      \lb\lb
 * Unless otherwise indicated, attributes can be set on a LAG logical port. See
 * ''Link Aggregation (LAG) Management'' for further details.
 *                                                                      \lb\lb
...
enum _fm_portAttr
{
    ...
    /** Type fm_int: Maximum frame size in bytes, ranging from 0 to 15864 with
     *  a default value of 1536. Note that a specified value will be rounded
     *  up to the nearest multiple of 4.
     *                                                                  \lb\lb
     *  This attribute may be set for the CPU interface port.
     *                                                                  \lb\lb
     *  Note: For ISL Tag enabled ports, the actual port configuration is
     ...
     *                                                                  \lb\lb
     *  FM6000 devices will be supported in a future release.
     *
     *  \chips  FM2000, FM3000, FM4000, FM6000 */
    FM_PORT_SECURITY,
     ...
     *                                                                  \lb\lb
     *  FM_TAG_ADD to treat the incoming frame as if it is untagged for the
     *  purpose of VLAN1 association and tagging. The frame is associated with
     *  the per port VLAN1 default. If the frame leaves the switch tagged in
     ...
     *                                                                  \lb\lb
     *  FM_TAG_ADD_NO_DEFAULT to treat the incoming frame as untagged but
     *  do not associate the port default vlan1 and vpri1 to the frame. In
     *  FM3000 and FM4000 devices, this allows the vlan1 tag to be passed 
     *  into the FFU for processing so a new vlan1 and vpri1 can be assigned.
     *                                                                  \lb\lb
     *  FM_TAG_KEEP (default) to tag only untagged frames.
     *                                                                  \lb\lb
     *  FM_TAG_REPLACE to overwrite all frames with the port's default
     *  VLAN1 and VPRI1. 
     *                                                                  \lb\lb
     ...
     *                                                                  \lb\lb
     *  FM_TAG_ADD to treat the incoming frame as if it is untagged for the
     *  purpose of VLAN2 association and tagging. The frame is associated with
     *  the per port VLAN2 default. If the frame leaves the switch tagged in
     *  802.1Q mode, it gets an additional VLAN2 tag. If the frame leaves the
     *  switch untagged in 802.1Q mode, then any original VLAN2 is preserved,
     *  but this tag is not added.
     *                                                                  \lb\lb
     *  FM_TAG_ADD_NO_DEFAULT to treat the incoming frame as untagged but
     *  do not associate the port default vlan2 and vpri2 to the frame. This
     *  allows the vlan2 tag to be passed into the FFU for processing so a new
     *  vlan2 and vpri2 can be assigned.
     *                                                                  \lb\lb
     *  FM_TAG_KEEP (default) to tag only untagged frames.
     *                                                                  \lb\lb
     *  FM_TAG_REPLACE to overwrite all frames with the port's default
     *  VLAN2 and VPRI2.
     *                                                                  \lb\lb
     *  Note that the port's default VLAN2 is set with the ''FM_PORT_DEF_VLAN2'' 
     *  attribute and the default VPRI2 is set with the ''FM_PORT_DEF_PRI2''
     *  attribute. 
     *
     *  \chips  FM6000 */
    FM_PORT_TAGGING2,
     ...
     *  violation: FM_ENABLED or FM_DISABLED (default). 
     *
     *  \chips  FM2000, FM3000, FM4000, FM6000 */
    FM_PORT_DROP_BV,
     ...
     *  FM_DISABLED (default).
     *                                                                  \lb\lb
     *  Note that if enabled, and the ''FM_PORT_TAGGING'' attribute is set to
     *  FM_TAG_ADD or FM_TAG_ADD_NO_DEFAULT, 
     *  then this filter will result in a discard if the incoming
     *  frame does not have its first level tag. That is, the ethertype does
     *  not equal the VLAN. 
     *                                                                  \lb\lb
     *  On FM2000, FM3000 and FM4000 devices, if Ethertype = VLAN but the 
     *  VLAN ID is 0 (priority tagged frame), the frame is considered VLAN 
     ...
     *  FM_DISABLED (default).
     *                                                                  \lb\lb
     *  On FM3000, FM4000, and FM6000 devices, this attribute will enable
     *  or disable RX PAUSE for all traffic classes.  Use 
     ...
     *  enabled on this SMP.  This is a superset of
     *  ''FM_PORT_LOSSLESS_PAUSE'', which represents the PAUSE enabled bit for
     *  SMP0 only.  This attribute requires that the ''FM_AUTO_PAUSE_MODE''
     *  switch QoS attribute be enabled. The default value is zero.
     *                                                                  \lb\lb  
     *
     *  \chips  FM3000, FM4000, FM6000 */
     ...
     *                                                                  \lb\lb
     *  On FM6000 devices, if ''FM_PORT_FABRIC_LOOPBACK'' is enabled, then
     ...
     *  FM85XXEP Evaluation Platform, it is set to FM_ENABLED on system start 
     *  up. 
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *                                                                  \lb\lb
     ...
     *  Valid values are:
     *                                                                  \lb\lb
     *  FM_PORT_RX_PAUSE_CLASS_BASED
     *                                                                  \lb\lb
     *  FM_PORT_RX_PAUSE_NORMAL (default).
     *
     *  \chips  FM3000, FM4000, FM6000 */
     ...
     *                                                                  \lb\lb
     *  For FM3000 and FM4000 devices, the value is 8-bits and the default value
     *  is 0xFF, indicating that all traffic classes have PAUSE enabled.
     *                                                                  \lb\lb
     *  For FM6000 devices, the value is 12-bits and the default value
     *  is 0xFFF, indicating that all traffic classes have PAUSE enabled.
     *                                                                  \lb\lb
     ...
     *  codeword received via the auto-negotiation protocol. This attribute 
     *  is read-only.  
     *                                                                  \lb\lb 
     *  NOTE: Clause 37 and SGMII use only the low-order 32 bits.
     *                                                                  \lb\lb
     *  This attribute cannot be read for a LAG logical port.
     *
     *  \chips  FM3000, FM4000, FM6000 */
     ...
     *  received from the link partner. This attribute is read-only.
     *                                                                  \lb\lb  
    ...
    /** Type fm_uint32: The Clause 73 link_fail_inhibit_timer in microseconds
     *  for links other than 1000BASEX-KX or 10GBASE-KX4 (see 
     *  ''FM_PORT_AUTONEG_LINK_INHB_TIMER_KX'' for 1000BASEX-KX and 
     *  10GBASE-KX4 links). The default is 500ms. Setting a value of zero 
     *  will automatically reset this attribute to its default value.
     *                                                                  \lb\lb  
    ...
    /** Type fm_uint32: The Clause 73 link_fail_inhibit_timer in microseconds
     *  for 1000BASEX-KX and 10GBASE-KX4 links only (see 
     *  ''FM_PORT_AUTONEG_LINK_INHB_TIMER'' for other types of links).
     *  The default is 50ms. Setting a value of zero will automatically 
     ...
     *  (if any) present on frames ingressing on this port.  Defaults to
     *  ''FM_ISL_TAG_NONE''. See ''fm_islTagFormat'' for more information. 
     *                                                                  \lb\lb
    ...
    /** Type fm_bool: Defines whether the port may modify the
     *  DSCP field on outgoing routed frames:
     *  FM_ENABLED (default) or FM_DISABLED.
     *                                                                  \lb\lb
     *  This attribute may be set for the CPU interface port.
     *                                                                  \lb\lb  
     ...
     *  the amount of available deep inspection by 16 bits. 
     *  FM_ENABLED or FM_DISABLED (default).
     *  
     ...
     *                                                                  \lb\lb
     *  For FM3000, FM4000 and FM6000: Setting the ''FM_UCAST_FLOODING''
     *  switch attribute may override the setting of this attribute for all
     *  ports. See ''FM_UCAST_FLOODING'' for more information.
     *                                                                  \lb\lb
     *  For FM6000: Setting this attribute will change the
     ...
     *                                                                  \lb\lb
     *  For FM3000, FM4000 and FM6000: Setting the ''FM_MCAST_FLOODING''
     *  switch attribute may override the setting of this attribute for all
    ...
    /** Type fm_bool: Defines whether a port is to transmit
     *  flooded multicast frames: FM_DISABLED (default) to allow flooding
     *  of multicast frames, or FM_ENABLED to drop flooded multicast frames.  
     *
     *  \chips  FM3000, FM4000, FM6000 */
     ...
     *  FM_STAT_GROUP_PER_PORT_TRIGGER_COUNTERS.
     *                                                                  \lb\lb
     *  For FM2000 and FM6000 devices, see the ''FM_STAT_GROUP_ENABLE'' 
     *  switch attribute.   
     *
     *  \chips  FM3000, FM4000 */
    FM_PORT_STAT_GROUP_ENABLE,
     ...
     *  is enabled or disabled for a port.  Value is either FM_ENABLED or
     *  FM_DISABLED (default).  Note that this attribute has no effect when 
     *  a port is a member of a link aggregation group.  
     *
     *  \chips  FM3000, FM4000, FM6000 */
     ...
     *  logic ignores IFG errors.  Default is FM_DISABLED. 
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *                                                                  \lb\lb
     *  On FM6000 devices, this attribute is applied per-MAC.
    ...
    /** Type fm_uint32: Receive lane polarity. Value is a 4-bit 
     *  mask (0x0 - 0xF), where bit 0 (the low-order bit) represents lane A, 
     *  bit 1 is lane B, bit 2 is lane C and bit 3 is lane D. A bit value of 
     *  zero indicates normal polarity. A bit value of 1 indicates reverse
     *  polarity. For convenience, the following mask values are pre-defined:
     *                                                                  \lb\lb
    ...
    /** Type fm_uint32: Transmit lane polarity. Value is:
     *                                                                  \lb\lb
     *  FM_PORT_LANE_POLARITY_NORMAL (default) to set normal lane polarity 
     *  on all lanes.
     *                                                                  \lb\lb
     *  FM_PORT_LANE_POLARITY_INVERT to reverse lane polarity on all lanes.
     *                                                                  \lb\lb
     *  On FM2000, FM3000 and FM4000 devices, the lanes cannot be individually
     *  controlled for TX as they can for RX. All lanes are set to the same 
     *  polarity. 
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *                                                                  \lb\lb
     *  On FM6000 devices, this attribute is applied per-lane per-MAC.
     *                                                                  \lb\lb
     *  While the API defaults to FM_PORT_LANE_POLARITY_NORMAL on all ports,
     *  the platform layer may change this default on system startup depending 
     *  on the layout of the board or the capabilities of any PHYs used on the 
     ...
     *  this value. The default value is 64. A value of 0 means that
     *  padding is disabled. Note that the value must be a multiple
     *  of 4, otherwise it will be truncated to the
     *  closest lower 4 byte boundary.
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *
     *  \chips  FM6000 */
    ...
    /** Type ''fm_dfeMode'': The port Receiver DFE Tuning Mode. This 
     *  attribute is applied per-lane, per-MAC.
     *                                                                  \lb\lb
     *  See ''fm_dfeMode'' for a complete description of all
     *  possible values for this attribute, including the default value.
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *
     *  \chips  FM6000 */
     ...
     *  if the value is temporarily unavailable. This attribute is read-only
     *  per-lane, per-MAC.
     *                                                                  \lb\lb
     *  Not applicable to a LAG logical port
     *
     *  \chips  FM6000 */
    FM_PORT_EYE_SCORE,

    /** Type ''fm_dfeState'': The port receiver coarse DFE tuning
     *  state.  This attribute is read-only per-lane, per-MAC.
     *                                                                  \lb\lb
     ...
     *                                                                  \lb\lb
     *  The API defaults to a value of 0 on all ports, however, the platform
     *  layer may change this default on system startup, as is done on the
     *  Barcelona reference platform, for example. 
     *                                                                  \lb\lb
     *  This attribute cannot be set on a LAG logical port.
     *  
     *  \chips  FM6000 */
     ...
     *  MAC_1588_STATUS register and send an ''FM_EVENT_EGRESS_TIMESTAMP''
     *  event to the API. It will also reset the status register,
     ...
     *                                                                  \lb\lb
     *  Note that ''FM_PORT_ISL_TAG_FORMAT'' must be set to
     *  ''FM_ISL_TAG_NONE''.
     *  
     *  \chips  FM6000 */
    FM_PORT_STRIP_VNTAG,

    /** Type: fm_bool. Experimental attribute. For internal use
...
typedef enum
{
     ...
     * 
     *  The F56 ISL TAG format will be functional in a future release.
     *  
     *  \chips  FM6000 */
    FM_ISL_TAG_F56,
...
enum _fm_lagAttr
{
    ...
    /** Type fm_bool: Indicates whether LAG filtering is enabled: FM_ENABLED
     *  (default) or FM_DISABLED. The index specifies the LAG number.
     *                                                                  \lb\lb
     *  For the FM3000/FM4000 this will set (FM_ENABLED) or clear (FM_DISABLED)
     *  the "InLAG" bit (bit 9) of the LAG_CFG register on every member port of
     *  the LAG.  When disabled, packets will not get hashed when forwarded
     *  to the LAG.  All LAG member ports will transmit a copy of the
     *  packet (similar to a multicast group).
     *  
     *  For FM6000:  TBD
     *  
     *  \chips  FM3000, FM4000, FM6000 */
...
/**************************************************
 * For FM_LAG_TRANSITION
 **************************************************/
#define FM_LAG_TRANSITION_IMMEDIATE       0
#define FM_LAG_TRANSITION_DELAYED         1
#define FM_LAG_TRANSITION_MARKER          2
...
enum _fm_qosPortAttr
{
     ...
     *  7. The index is the traffic class and may range from 0 to 11.
     *                                                                  \lb\lb
    ...
    /** Type fm_uint32: PAUSE class memory partition mapping. The value of
     *  the attribute is the RX memory partition and may range from 0 to 11.
     *  The index is the PAUSE class and may range from 0 to 7.
     *
     *  \chips  FM6000 */
    FM_QOS_PC_RXMP_MAP,
     ...
     *  FM2000 family.
     *                                                                  \lb\lb
     *  For FM3000 and FM4000 devices, the VLAN egress priority is 0 through 
     *  7 if the ''FM_PORT_TXCFI'' is set to FM_PORT_TXCFI_ASIS or 0 through 
     *  15 if the ''FM_PORT_TXCFI'' is set to FM_PORT_TXCFI_ISPRIBIT. The 
     *  internal priority is a VLAN priority.
     *                                                                  \lb\lb
     *  For FM6000 devices, the VLAN egress priority is TBD. 
     *                                                                  \lb\lb
     ...
     *  class in bytes and may range from 0 to 4,193,792 with a default value 
     *  of 4,193,792. The API will round up the specified attribute value to 
     *  the nearest 512-byte boundary, so the value returned by ''fmGetPortQOS'' 
     *  may not exactly match the value set with ''fmSetPortQOS''. The 
     *  attribute index (0 - 7) indicates the traffic class.
     *                                                                  \lb\lb
     *  Note: when the ''FM_AUTO_PAUSE_MODE'' switch QoS attribute is
     *  enabled, this attribute will be automatically calculated by the API,
     ...
     *  from 0 to 7 and the traffic class index may range from 0 to 7.
     *                                                                  \lb\lb
     ...
     *  range from 0 to 255 and the default is 20. 
     *                                                                  \lb\lb
     *  Setting this attribute overrides the value of 
     ...
     *  0 to 10,000,000,000 (10Gbps) with a default value of 10Gbps. The
     *  attribute index is the shaping group (0 - 7). 
     *                                                                  \lb\lb
     ...
     *  read-only. The granularity of the measurement is 512 bytes. The
     *  attribute index (0 - 7) indicates the traffic class. 
     *
     *  \chips  FM3000, FM4000 */
    FM_QOS_TX_TC_USAGE,
    ...
    /** Type fm_uint32: The number of scheduling groups of a port.
     *  The maximum number of scheduling groups is 12. The minimum number of
     *  scheduling groups is 1. The default is TBD. 
     *
     *  \chips  FM6000 */
     ...
     *  example, with 12 scheduling groups, groups 0 to 4 are in priority set
     *  0, and groups 5 to 11 are in priority set 1. The attribute index is
     *  the group number (0 to NUM_SCHED_GROUPS - 1). The default is TBD. 
     *
     *  \chips  FM6000 */
     ...
     *  priority for round-robin. The attribute index is the group number
     *  (0 to NUM_SCHED_GROUPS - 1). The default is TBD. 
     *
     *  \chips  FM6000 */
    ...
    /** Type fm_uint32: one of the traffic class boundaries of 
     *  a scheduling group. A scheduling group includes one or more traffic 
     *  classes with successive TC numbers. So we use two boundaries to define 
     *  the traffic classes in a scheduling group. If the two boundaries are 
     *  the same in a scheduling group, this group only contains one TC. 
    ...
    /** Type fm_uint32: one of the traffic class boundaries of a 
     *  scheduling group. A scheduling group includes one or more traffic 
     *  classes with successive TC numbers. So we use two boundaries to define 
     *  the traffic classes in a scheduling group. If the two boundaries are 
     *  the same in a scheduling group, this group only contains one TC. 
     *  The attribute index is the group number (0 to NUM_SCHED_GROUPS - 1).
     ...
     *  enabled. The value of this attribute is 12 bits with each bit 
     *  corresponding to a traffic class, such that bit 0 represents traffic 
     *  class 0 and bit 11 represents traffic class 11. When the corresponding 
     *  bit of a traffic class is 1, that traffic class is enabled. 
     *  Otherwise, it is disabled. The default is TBD. 
     *
     *  \chips  FM6000 */
    FM_QOS_TC_ENABLE,

    /** Type fm_uint32: Indicates whether packet lengths in a
     *  traffic class are counted as zero. The value of this attribute is 
     *  12 bits with each bit corresponding to a traffic class, such that 
     *  bit 0 represents traffic class 0 and bit 11 represents traffic class 
     *  11. When the corresponding bit of a traffic class is 1, the length of 
     *  packets from that traffic class is counted as zero. The default is 
     *  TBD. 
     *
     *  \chips  FM6000 */
    FM_QOS_TC_ZERO_LENGTH,

    /** Type fm_uint32: Apply new egress scheduler configuration
     *  to switch. 
     *
     *  \chips  FM6000 */
...
enum _fm_qosSwAttr
{
     ...
     *                                                                  \lb\lb
     *  The attribute value is 12-bits where each bit corresponds to an RXMP.
     *  Bit 0 is RXMP 0, bit 1 is RXMP 1, etc.  A bit value of 1 indicates that 
     *  the port may generate a pause frame due to the shared watermarks and
     *  a value of 0 indicates that the port disregards shared watermarks.
     *  The default is 0xFFF.
     *
     *  \chips  FM6000 */
    FM_QOS_SHARED_PAUSE_ENABLE,

    /** Type fm_int: The RXMP soft drop watermark in bytes per ISL priority.
     *  The value may range from 0 to 7,863,840 with a default value of 
     *  7,863,840. The index (0 - 15) indicates the ISL priority. Frames are 
     ...
     *  480-byte boundary, so the value returned by ''fmGetSwitchQOS'' may 
     *  not exactly match the value set with ''fmSetSwitchQOS''.  
     *
     *  \chips  FM6000 */
    FM_QOS_SHARED_SOFT_DROP_WM,
     ...
     *  priority. The value may range from 0 to 7,863,840 with a default
     *  value of 7,863,840. The index (0 - 15) indicates the ISL priority. 
    ...
    /** Type fm_uint32: Global DSCP priority to switch priority
     *  map.  The attribute value is the switch priority and may range from
     *  0  to 15 with a default value of 0. The attribute index indicates the
     *  DSCP value (0 - 63). 
     *
     *  \chips  FM3000, FM4000, FM6000 */
    FM_QOS_DSCP_SWPRI_MAP,

    /** Type fm_uint32: Global switch priority to 
     *  traffic class map. The attribute value is the traffic class and the
     *  attribute index is the switch priority (0 - 15)
     *                                                                  \lb\lb
    ...
    /** Type fm_uint32: The congestion notification sampling
     *  period. For VCN mode, the value is in units of microseconds. For FCN
     *  mode, the value is in units of bytes. Default is TBD. 
     *
     *  \chips  FM3000, FM4000, FM6000 */
    FM_QOS_CN_SAMPLING_RATE,
     ...
     *  manipulated automatically by the API and cannot be set by the
     *  application:
     *                                                                  \lb\lb
    ...
    /** Type fm_uint32: Maps a class of trapped frame to a switch priority.
     ...
     *  ''FM_SWITCH_PRIORITY_MAX'' - 1). Frame classes may be any of the
     *  following:                                  
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_BPDU for STP protocol frames. Trapping of these
     *  frames is enabled with the ''FM_TRAP_IEEE_BPDU'' switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_CPU_MAC for frames that are received with
     *  the configured CPU MAC address as the destination MAC address. The
     *  CPU MAC adderss is configured with the ''FM_CPU_MAC'' switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_GARP for GARP protocol frames. Trapping of these
     *  frames is enabled with the ''FM_TRAP_IEEE_GARP'' switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_IEEE for IEEE frames not otherwise enumerated.
     *  Trapping of these frames is enabled with the ''FM_TRAP_IEEE_OTHER'' 
     *  switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_ICMP for ICMP protocol frames.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_IGMP for IGMP protocol frames. Trapping of these
     *  frames is enabled with the ''FM_VLAN_IGMP_TRAPPING'' VLAN attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_IP_OPTION for trapped frames with IP options.
     *  Trapping of these frames is enabled with the 
     *  ''FM_ROUTER_TRAP_IP_OPTIONS'' router attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_LACP for LACP protocol frames. Trapping of these
     *  frames is enabled with the ''FM_TRAP_IEEE_LACP'' switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_802_1X for 802.1x protocol frames. Trapping of
     *  these frames is enabled with the ''FM_TRAP_IEEE_8021X'' switch 
     *  attribute. 
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_MTU_VIOLATION for trapped frames with MTU
     *  violations. Trapping of these frames is enabled with the
     *  ''FM_TRAP_MTU_VIOLATIONS'' switch attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_MCAST_FLOODING for multicast frames
     *  received with an unknown address. Trapping of these frames
     *  is enabled with the ''FM_PORT_MCAST_FLOODING'' port
     *  attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_UCAST_FLOODING for unicast frames received
     *  with an unknown destination address. Trapping of these
     *  frames is enabled with the ''FM_PORT_UCAST_FLOODING'' port
     *  attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_TTL1 for routed frames received with TTL
     *  field set to 1 or 0. Trapping of these frames is enabled
     *  with the ''FM_ROUTER_TRAP_TTL1'' router attribute.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_NEXTHOP_MISS for frames trapped to CPU
     *  because of a miss in the next hop (ARP) table.
     *                                                                  \lb\lb
     *  FM_QOS_TRAP_CLASS_ARP for ARP frames logged to CPU. Logging
     *  of these frames is enabled with the ''FM_VLAN_ARP_LOGGING''
     *  VLAN attribute and ''FM_PORT_LOG_ARP'' port attribute.
     *                                                                  \lb\lb
...
typedef enum
{
    /** All VLANs share a single spanning tree instance and source MAC
     *  addresses are learned globally (not per-VLAN). Port spanning tree
     *  states are set using ''fmSetVlanPortState''. 
     *
     *  \chips  FM2000, FM3000, FM4000, FM6000 */
    FM_SPANNING_TREE_SHARED = 0,

    /** Each VLAN has its own spanning tree instance and source MAC addresses
     *  are learned per-VLAN.  Port spanning tree states are set using
     *  ''fmSetVlanPortState''. 
     *
     *  \chips  FM2000, FM3000, FM4000 */
     ...
     *  instance). Source MAC addresses are learned per-VLAN. 
     *
     *  \chips  FM3000, FM4000, FM6000 */
...
typedef enum
{
    /** Frames are learned on the VLAN that they are
     *  received on.  The spanning tree state is independently
     *  derived based on the setting of FM_SPANNING_TREE_MODE.
     *
     *  \chips  FM6000 */
    FM_VLAN_LEARNING_MODE_INDEPENDENT,

    /** Frames are learned on a single VLAN that they are
     *  received on.  The spanning tree state is independently
     *  derived based on the setting of FM_SPANNING_TREE_MODE.
     *  The learned vlan is configured by setting the
     *  FM_VLAN_LEARNING_SHARED_VLAN switch attribute.
     *
     *  \chips  FM6000 */
...
typedef enum
{
    ...
    /** Single-loop Dynamic DFE Tuning. */
    FM_DFE_MODE_ONE_SHOT,

    /** Dynamic DFE tuning, featuring continuous fine tuning
     *  adaptations. This is also the default value for
     *  ''FM_PORT_DFE_MODE'' for non-KR configurations. */
    FM_DFE_MODE_CONTINUOUS,


    /** Adaptive hardware-assisted DFE tuning. Supported only
     *  by KR-type interfaces. This is the default value for 
     *  ''FM_PORT_DFE_MODE'' for KR configurations. */
    FM_DFE_MODE_KR
...
/** \ingroup typeEnum
 *
 * List of trap types that may appear in ''fm_trapCodeMapping''.
 ****************************************************************************/
typedef enum
{
    /** Trapped BPDU frame.
    ...
    /** On FM3000 and FM4000 devices, trapped frame due to TTL <= 1 for 
     *  non-ICMP frames.
     *                                                                  \lb\lb
 ...
 *  ''FM_FFU_SLICE_ALLOCATIONS'' switch attribute. See the description of
 *  ''FM_FFU_SLICE_ALLOCATIONS'' for more information.
 *                                                                      \lb\lb
 ...
 *  Typically, routes are placed at the beginning of the FFU (starting at
 *  slice 0) and ACLs are placed at the end of the FFU (ending at slice
 *  31, since this is the only slice that supports egress ACLs).
 *                                                                      \lb\lb
...
typedef struct _fm_ffuSliceAllocations
{
     ...
     *  to the value supplied in the ''api.FM4000.ffu.unicastSliceRangeFirst'' 
     *  API attribute. */
     ...
     *  ''api.FM4000.ffu.unicastSliceRangeLast'' API attribute. */
     ...
     *  ''api.FM4000.ffu.multicastSliceRangeFirst'' API attribute. */
     ...
     *  ''api.FM4000.ffu.multicastSliceRangeLast'' API attribute. */
     ...
     *  entry is 8 slices wide, so allocations should be in multiples of 8
     *  slices. This attribute defaults to the value supplied in the 
     *  ''api.FM4000.ffu.multicastSliceRangeLast'' API attribute. */
    fm_int ipv6MulticastLastSlice;

    /** First FFU slice used for ACLs. This attribute defaults to the value 
     *  supplied in the ''api.FM4000.ffu.aclSliceRangeFirst'' API attribute. */
     ...
     *  ''api.FM4000.ffu.aclSliceRangeLast'' API attribute. */
    fm_int aclLastSlice;
     ...
     *  ''api.FM4000.ffu.cVlanSliceRangeLast'' API attribute. */
...
typedef struct _fm_L2HashKey
{
     ...
     *                                                                  \lb\lb
     *  On FM3000 and FM4000 devices, this field acts as a boolean
...
typedef struct _fm_L3HashConfig
{
     ...
     *  non-ip / ipv4 frames. For such scenario, multiple hashing
     ...
     *  channels bits may be filled with deep inspection data for
     *  non-ip / ipv4 frames. For such scenario, multiple hashing
     *  profiles should be created as needed to apply a proper
     *  hashing mask to non-ip, ipv4 and ipv6 frames.
     *  
