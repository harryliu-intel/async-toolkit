...
MODULE PicklesPM3 EXPORTS Pickles;
IMPORT Pickle AS Pickle, TextWr, TextRd, Wr, Thread, SlowTextCompress, Database;
...
PROCEDURE UnStuffOC(rd : Rd.T;
  ...
  BEGIN
    ...
    Debug.Out("PicklesPM3.UnStuffOC: ByteA2TextRdWr done.");
    ...
    Debug.Out("PicklesPM3.UnStuffOC: SlowTextCompress.RdWr done.");
