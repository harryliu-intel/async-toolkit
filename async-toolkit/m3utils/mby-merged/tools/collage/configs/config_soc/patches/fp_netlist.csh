...
cd $CONFIG_GEN
set __fpngen_ward=fp_unit_netlist
...
/bin/cp $CONFIG_GEN/source/rtl/par_*.sv inputs/
/bin/cp $CONFIG_GEN/source/rtl/soc.sv inputs/
...
dc_shell -f $REPO_ROOT/collage/patches/gen_fp_netlist.tcl
