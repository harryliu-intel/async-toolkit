...
// /nfs/sc/proj/ctg/mrl108/rliu68/sw-intel5/cad/java/src/./com/fulcrummicro/hw/verification/chip/mgmt/registers/templates/VfUL.jamon
...
String pakkage = prefix.concat("registers_pkg").toLowerCase();
    ...
    {
      // 286, 1
      __jamon_innerUnit____decl(jamonWriter, "ADDR_BITS", __DECL_BASE_WIDTH , null, "localparam");
    }
    // 286, 80
    jamonWriter.write(" = ");
    // 287, 1
    ...
    for (RegisterBase b : bases )
    {
      ...
      {
        // 308, 1
        __jamon_innerUnit____decl(jamonWriter, b.getFullName(), __DECL_BASE_WIDTH , null, "localparam");
      }
      // 308, 84
      jamonWriter.write(" = ");
      // 309, 1
...
for (Register r : b.getRegisters()) {
    w = Math.max(w, r.getEntryWidth());
      ...
      {
        // 318, 1
        __jamon_innerUnit____decl(jamonWriter, b.getName().toUpperCase(), __DECL_BASE_WIDTH , "_MAX_WIDTH", "localparam");
      }
      // 318, 117
      jamonWriter.write(" = ");
      // 319, 1
...
boolean w = r.getEntryWidth() > 1;
      ...
      {
        // 336, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_DEFAULT" , "localparam");
      }
      // 336, 78
      jamonWriter.write(" = ");
      // 337, 1
      ...
      {
        // 339, 1
        __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_WIDTH" , "localparam");
      }
      // 339, 76
      jamonWriter.write(" = ");
      // 340, 1
      ...
      if (nDims == 0 )
      {
        ...
        {
          // 343, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, w ? "(word)" : "()" , "`define");
        }
        // 343, 84
        jamonWriter.write(" (");
      }
      ...
      else if (nDims == 1 )
      {
        ...
        {
          // 345, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, w ? "(index, word)" : "(index)" , "`define");
        }
        // 345, 96
        jamonWriter.write(" ((");
        // 346, 2
      ...
      else if (nDims == 2 )
      {
        ...
        {
          // 348, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, w ? "(index1, index0, word)" : "(index1, index0)" , "`define");
        }
        // 348, 114
        jamonWriter.write(" ((");
        // 349, 2
      ...
      else if (nDims == 3 )
      {
        ...
        {
          // 352, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, w ? "(index2, index1, index0, word)" : "(index2, index1, index0)" , "`define");
        }
        // 352, 130
        jamonWriter.write(" ((");
        // 353, 2
...
ConstantsEnumValue c = it.next();
      ...
      {
        // 60, 1
        __jamon_innerUnit____decl(jamonWriter, c.getVerilogName().toUpperCase(), __DECL_ENUM_WIDTH , null, "    ");
      }
      // 60, 95
      jamonWriter.write(" = ");
      // 61, 1
...
Collection<RegisterField> fields = r.getSortedFields(false, true, false, false);
    ...
    for (RegisterField f : fields )
    {
      ...
      if (f.len == 1 )
      {
        ...
        {
          // 159, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_b_" + f.desc , "localparam");
        }
        // 159, 82
        jamonWriter.write(" = ");
        // 160, 1
      ...
      else
      {
        ...
        {
          // 162, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_l_" + f.desc , "localparam");
        }
        // 162, 82
        jamonWriter.write(" = ");
        // 163, 1
        ...
        {
          // 164, 1
          __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_h_" + f.desc , "localparam");
        }
        // 164, 82
        jamonWriter.write(" = ");
        // 165, 1
        ...
        if (f.entries > 1 )
        {
          ...
          {
            // 167, 1
            __jamon_innerUnit____decl(jamonWriter, r.getName(), __DECL_DEFAULT_WIDTH, "_s_" + f.desc , "localparam");
          }
          // 167, 82
          jamonWriter.write(" = ");
          // 168, 1
  ...
  // 21, 1
  private void __jamon_innerUnit____decl(final java.io.Writer jamonWriter, final String name, final int w, final String suffix, final String keyword)
    throws java.io.IOException
  {
    // 28, 1
