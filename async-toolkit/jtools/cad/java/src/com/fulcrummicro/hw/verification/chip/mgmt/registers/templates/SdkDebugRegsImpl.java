...
String s = String.format("0x%1X%1X,", flags[1], flags[0]);
  ...
  // 8, 1
  private void __jamon_innerUnit____diminfo(final java.io.Writer jamonWriter, final Register r, final int d, final boolean stride, final boolean offset, final boolean max)
    throws java.io.IOException
  {
    // 16, 1
