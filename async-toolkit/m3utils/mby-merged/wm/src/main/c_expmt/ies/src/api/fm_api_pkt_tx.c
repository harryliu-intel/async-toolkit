 ...
 *                  the proper port state or STP states for direct packet send.
 ...
 *                  transmitted to the port indicated by the caller. In that 
 *                  case, this function will respect the spanning tree state 
 *                  of the destination port, but only if the switch is 
 *                  configured in shared spanning tree mode. In per-VLAN 
 *                  and multiple spanning tree modes, it is the responsibility 
 *                  of the application to assess the spanning tree state of 
 *                  the destination port/VLAN prior to calling this function.
 *
 * \note            If this function returns FM_OK, ownership of the
 *                  ''fm_buffer'' chain containing the message packet
 *                  has been successfully transferred to the API. The caller
 ...
 *                                                                      \lb\lb
 *                  This function will respect the spanning tree state of the 
 *                  destination port(s), but only if the switch is configured 
 *                  in shared spanning tree mode. In per-VLAN and multiple 
 *                  spanning tree modes, the packet will be transmitted
 *                  regardless of spanning tree state.
 *
 * \note            If this function returns FM_OK, ownership of the
 *                  ''fm_buffer'' chain containing the message packet
 *                  has been successfully transferred to the API. The caller
 ...
 *
 * \return          FM_OK if successful.
 * \return          FM_ERR_INVALID_SWITCH if the switch is down.
 * \return          FM_ERR_INVALID_PORT_STATE if the ports contained in the 
 *                  portList are not in the proper port state or STP states.
