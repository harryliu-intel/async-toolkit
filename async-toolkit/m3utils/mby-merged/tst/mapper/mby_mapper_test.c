...
{
	const unsigned char
			ip_hdr[] = {	0x45, 0x00, 0x00,   62, // 62 is len
...
typedef void(*run_on_simple_tcp_setup_fn)(fm_uint32[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper*);
typedef int(*run_on_simple_tcp_check_fn)(fm_uint32[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier*);
							  ...
							  run_on_simple_tcp_check_fn check)
{
	...
	if (!check(regs, &mapper_to_classifier))
		ret = 0;
...
static void simple_tcp_basic_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{

}

static int simple_tcp_basic_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
	return 1;
}

static void simple_tcp_act24_default_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
	//act24[0]
	// lower
...
static int simple_tcp_act24_default_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_act4_default_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_act4_default_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_default0_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_default0_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_RE_KEYS_OUTER_VLAN1_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_RE_KEYS_OUTER_VLAN1_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_default_forced_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_default_forced_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void activate_profile_0(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE])
{
	// PROFILE
...
static void simple_tcp_map_smac_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static void simple_tcp_map_prot_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_map_prot_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_map_l4dst_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_map_l4dst_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_PRIORITY_PROFILE_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_PRIORITY_PROFILE_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
...
static void simple_tcp_NO_PRI_ENC_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
static int simple_tcp_NO_PRI_ENC_test_check(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], const mbyMapperToClassifier* in)
{
	MAPPER_TEST_ASSERT(!in->NO_PRI_ENC, "NO_PRI_ENC");
...
static void simple_tcp_LEARN_MODE_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
    fm_uint32 map_domain_action0_vals[MBY_MAP_DOMAIN_ACTION0_WIDTH] = { 0 };
...
static void simple_tcp_VLAN_COUNTER_test_setup(fm_uint32 reg[MBY_REGISTER_ARRAY_SIZE], mbyParserToMapper* inout)
{
...
{
	fm_uint fails = 0;
	printf("mby_mapper tests:\n");

	SIMPLE_TCP_TEST(basic, fails);
	SIMPLE_TCP_TEST(act24_default, fails);
	SIMPLE_TCP_TEST(act4_default, fails);
	SIMPLE_TCP_TEST(default0, fails);
	SIMPLE_TCP_TEST(RE_KEYS_OUTER_VLAN1, fails);
	SIMPLE_TCP_TEST(default_forced, fails);
	SIMPLE_TCP_TEST(map_smac, fails);
	SIMPLE_TCP_TEST(map_prot, fails);
	SIMPLE_TCP_TEST(map_l4dst, fails);
	SIMPLE_TCP_TEST(PRIORITY_PROFILE, fails);
	SIMPLE_TCP_TEST(NO_PRI_ENC, fails);
	SIMPLE_TCP_TEST(LEARN_MODE, fails);
	SIMPLE_TCP_TEST(VLAN_COUNTER, fails);

	if (fails == 0) printf("PASS of mby_mapper\n"); else printf("FAIL of mby_mapper\n");
