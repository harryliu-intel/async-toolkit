...
//////////////////////////////////////////////////////////////////////
`include        "msh_mem.def"
module  mby_mem_msh_bank_ram_shell_4096x532(
        //------------------- clock and reset -------------------
        input                                   clk                     ,
        input                                   reset_n                 ,
        ...
        input                                   rd_en                   ,
        input                                   wr_en                   ,
        input         [532-1:0]         wr_data                 ,
        output  wire  [532-1:0]         rd_data                 ,
        ...
        mby_mgm_master_1rw_shell    #(
                ...
                .MEM_INIT_VALUE         (532'h0),             //              Init. Val. - valid only when MEM_INIT_TYPE == 1.
