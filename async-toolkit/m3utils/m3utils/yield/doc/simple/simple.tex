...
that the fabrication yield follows a Stapper-P\'olya-Eggenberger model with
...
So let's flog the Poisson distribution into service---this method is widely uesd
