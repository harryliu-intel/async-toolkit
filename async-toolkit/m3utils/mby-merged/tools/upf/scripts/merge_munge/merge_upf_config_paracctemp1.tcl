...
create_pst "vnn_island_paracctemp1_pd_pst" -supplies "ss_vnn.power ss_vnn.ground"
add_pst_state "p_0" -pst "vnn_island_paracctemp1_pd_pst" -state "v_0p75 v_0p00"
add_pst_state "p_1" -pst "vnn_island_paracctemp1_pd_pst" -state "v_off  v_0p00"
}
