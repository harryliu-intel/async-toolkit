...
functional model can repeat a large amount of duplicated work, as it is common
...
white model for CSR access.  Also, HLP was modeled in Simics (see
...
For management reasons, the Mount Steller (MST) team decided to modify
...
is not an insurmountable obstacle, and in fact, the fact that traditional techniques
...
is in some quarters still considered quite cutting-edge, as there remain
...
and strict management practices, which are also costly measures.
...
staffing constraints may demand that certain technologies be used and avoided.
...
can be adopted piecemeal and rejected without restarting the entire
program).
...
readers will see that this design approach is the natural consequence
...
we must use such tools are go through such design steps, the input to those
...
functional-model-as-specification (section~\ref{sec:fm-spec})
...
P.~Naur, A.~J.~Perlis, H.~Rutishauser, K.~Samelson, B.~Vauquois, J.~H.~Wegstein,
 A.~van~Wijngaarden, and M.~Woodger. {\it Revised Report on the Algorithmic Lang
uage}~{\scshape Algol 60}.  Berlin:\ Springer-Verlag, 1969.}

\bibitem{ref:burns_ms}  Steven~M.~Burns. {\it Automated Compilation of Concurren
t Programs into Self-timed Circuits.} M.S.\ thesis, Caltech \hbox{CS-TR-88-2}, C
alifornia Institute of Technology, 1988.
...
\bibitem{synthesis_tr} {Alain~J.~Martin.  {\it Synthesis of Asynchronous VLSI Ci
rcuits.}  Caltech Computer Science Technical Report \hbox{CS-TR-93-28}.  Pasaden
...
Asynchronous MIPS R3000 Processor. In R.~B.~Brown and A.~T.~Ishii, eds., {\it Pr
oceedings of the 17th
...
\bibitem{de_muller}{D.~E.~Muller and W.~S.~Bartky.  A theory of asynchronous circuits.  In {\it The Annals of the Computation Laboratory of Harvard University.
 Volume~XXIX:\ Proceedings of an International Symposium on the Theory of Switch
ing, Part~I.}, 1959, pp.~204--243.}
...
\bibitem{semantics-pred-calc}{Edsger~W.~Dijkstra and Carel~S.~Scholten.  {\it Predicate Calculus and Program Semantics.}  Berlin:\ Springer, 1990.}
...
\bibitem{pascal}{Kathleen Jensen and Nicklaus Wirth.  {\it PASCAL - User Manual and Report.}  Lecture Notes in Computer Science {\bf 18}. Berlin: Springer-Verlag, 1974.}

\bibitem{modula}{Nicklaus Wirth.  Modula: A language for modular programming.  {\it Software-Practice and Experience,} {\bf 7}, pp.~37--65, 1977.}
