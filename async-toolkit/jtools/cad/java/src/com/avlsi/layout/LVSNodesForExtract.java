 ...
 */
public class LVSNodesForExtract implements LVSNodes {
    ...
    public LVSNodesForExtract( final CastFileParser castParser,
                ...
                while ( stack.size() > 0 ) {
                    ...
                    if ( subcellPairIter.hasNext() ) {
                        ...
                        if ( stack.size() > 0 ) {
                            ...
                            final Frame newCurrFrame = ( Frame ) stack.getFirst();
                        
                            final SortedSet newCurrFrameLVSNodes = newCurrFrame.getLVSNodes();
                            ...
                            while ( lvsNodesIter.hasNext() ) {
                                ...
                                final HierName newLVSNode = HierName.append( currInstanceName,
                                                                             lvsNode );
                                
                                newCurrFrameLVSNodes.add( newLVSNode );
