...
fm_status fmEventHandlingInitialize(void)
{
    ...
    timeout           = fmGetIntApiAttribute(FM_AAK_API_EVENT_SEM_TIMEOUT,
                                             FM_AAD_API_EVENT_SEM_TIMEOUT);
    eventTimeout.sec  = timeout/1000;
    eventTimeout.usec = (timeout%1000)*1000;
     
    blockThreshold    = fmGetIntApiAttribute(FM_AAK_API_FREE_EVENT_BLOCK_THRESHOLD,
                                             FM_AAD_API_FREE_EVENT_BLOCK_THRESHOLD);
    unblockThreshold  = fmGetIntApiAttribute(FM_AAK_API_FREE_EVENT_UNBLOCK_THRESHOLD,
