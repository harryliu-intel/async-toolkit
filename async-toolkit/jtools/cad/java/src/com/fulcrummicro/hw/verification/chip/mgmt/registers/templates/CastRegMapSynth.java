...
// C:/Users/mhesseli/Documents/Perforce/rrc-4/reg-main/shared/java/src/./com/fulcrummicro/hw/verification/chip/mgmt/registers/templates/CastRegMapSynth.jamon
...
@org.jamon.annotations.Template(
  signature = "59A3F0EB26BEB75C41B44B800920C454",
  inheritanceDepth = 2,
  requiredArguments = {
  ...
  methods = {
    ...
    @org.jamon.annotations.Method(
      ...
      requiredArguments = {
        @org.jamon.annotations.Argument(name = "reg", type = "Register")})})
public class CastRegMapSynth
  extends com.fulcrummicro.hw.verification.chip.mgmt.registers.templates.CastCommon
{
  
  public CastRegMapSynth(org.jamon.TemplateManager p_manager)
  {
     super(p_manager);
  }
  
  protected CastRegMapSynth(String p_path)
  {
    super(p_path);
  }
  
  public CastRegMapSynth()
  {
     super("/com/fulcrummicro/hw/verification/chip/mgmt/registers/templates/CastRegMapSynth");
  }
  ...
  protected org.jamon.AbstractTemplateImpl constructImpl(){
    return new CastRegMapSynthImpl(getTemplateManager(), getImplData());
  }
  ...
  public com.fulcrummicro.hw.verification.chip.mgmt.registers.templates.CastCommon.ParentRenderer makeParentRenderer(final Collection<RegisterCrossbarPort> crossbarPorts, final Collection<RegisterBase> bases, final Collection<Register> regs, final String chip)
  {
    return new com.fulcrummicro.hw.verification.chip.mgmt.registers.templates.CastCommon.ParentRenderer() {
      @Override protected void renderChild(final java.io.Writer jamonWriter)
        throws java.io.IOException
      {
        CastRegMapSynth.this.renderNoFlush(jamonWriter, crossbarPorts, bases, regs, chip);
      }
    };
  }
