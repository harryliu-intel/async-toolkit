...
)
{
    ...
    wcm_action_cfg_r const * const wcm_action_cfg =
      &(cgrp_b_map->B.WCM_ACTION_CFG[ram_num][scenario % 12]);
    wcm_action_cfg_en_r const * const wcm_action_cfg_en =
      &(cgrp_b_map->B.WCM_ACTION_CFG_EN[ram_num]);
