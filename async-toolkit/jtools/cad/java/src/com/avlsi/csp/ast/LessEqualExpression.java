...
/**
 * Less than or equal to expression, represents <code>a &lt;= b </code>.
 *
 * @author Jesse Rosenstock
 * @version $Revision$ $Date$
 **/
public class LessEqualExpression extends AbstractBinaryExpression {
     ...
     **/
    public LessEqualExpression(final ExpressionInterface left,
    ...
    public void accept(VisitorInterface v) throws VisitorException {
        v.visitLessEqualExpression(this);
    }
