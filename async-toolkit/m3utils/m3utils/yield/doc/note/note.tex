...
&=& Y(1)^{18} + {18 \choose 17} Y(1)^{17}(1-Y) + {18 \choose 16} Y(1)^{17}(1-Y)^2\\
&=& Y(1)^{18} + 18 \, Y(1)^{17}(1-Y) + 153 \, Y(1)^{17}(1-2\,Y+Y^2) \\
...
\end{equation}
Compare (\ref{eq:yield16of18}).  The method is generally valid.
