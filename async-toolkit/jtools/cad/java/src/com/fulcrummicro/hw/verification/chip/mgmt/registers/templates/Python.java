...
@org.jamon.annotations.Template(
  signature = "68812252E0F7BC9B55724A28C8747A4D",
  inheritanceDepth = 1,
  requiredArguments = {
  ...
  extends com.fulcrummicro.util.jamon.timestamp
{
  ...
  public Python(org.jamon.TemplateManager p_manager)
  {
     super(p_manager);
  }
  
  protected Python(String p_path)
  {
    super(p_path);
  }
  ...
  public Python()
  {
     super("/com/fulcrummicro/hw/verification/chip/mgmt/registers/templates/Python");
  }
  ...
  protected org.jamon.AbstractTemplateImpl constructImpl(){
    return new PythonImpl(getTemplateManager(), getImplData());
  }
  ...
  public com.fulcrummicro.util.jamon.timestamp.ParentRenderer makeParentRenderer(final Collection<RegisterBase> bases, final Collection<Register> regs, final String prefix)
  {
    return new com.fulcrummicro.util.jamon.timestamp.ParentRenderer() {
      @Override protected void renderChild(final java.io.Writer jamonWriter)
        throws java.io.IOException
      {
        Python.this.renderNoFlush(jamonWriter, bases, regs, prefix);
      }
    };
  }
