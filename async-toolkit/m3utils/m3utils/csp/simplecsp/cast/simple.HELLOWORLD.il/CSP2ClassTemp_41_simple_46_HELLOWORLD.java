...
public final class CSP2ClassTemp_41_simple_46_HELLOWORLD extends CspRuntimeAbstractDevice {
...
// constructors
public CSP2ClassTemp_41_simple_46_HELLOWORLD(final DeviceParameters deviceParams, final ChannelInput[] in, final ChannelOutput[] out, final WideNode[] nodes
...
enterFrame(null);
{
setWhereAmI("/nfs/pdx/disks/or_n3a_disk001/w138/mnystroe/m3utils/csp/simplecsp/cast/simple.cast 49:4-49:26");
_print(new CspString("hello, world!"));
}
waitForever();
