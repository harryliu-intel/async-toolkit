...
set ::collage_ip_info::ip_input_files "$::env(MODEL_ROOT)/tools/collage/corekit_stubs/sla_pkg_stub.sv $::env(MODEL_ROOT)/subBlock/mbyc/src/shared/rtl/mby_gmm_pkg.sv $::env(MODEL_ROOT)/subBlock/mbyc/src/shared/rtl/shared_pkg.sv $::env(MODEL_ROOT)/subBlock/mbyc/src/gmm/gms/top/rtl/mby_gms.sv"
