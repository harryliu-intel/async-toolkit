...
//edr   .grp_d_rx_data_w_ecc(eth_bfm_rx_intf_3.data_w_ecc),
   .grp_a_rx_data({64'h0,eth_bfm_rx_intf_0.data_w_ecc}),
   .grp_b_rx_data({64'h0,eth_bfm_rx_intf_1.data_w_ecc}),
   .grp_c_rx_data({64'h0,eth_bfm_rx_intf_2.data_w_ecc}),
   .grp_d_rx_data({64'h0,eth_bfm_rx_intf_3.data_w_ecc}),
   .grp_a_tx_pfc_xoff(),
   .grp_b_tx_pfc_xoff(),                                                           
   .grp_c_tx_pfc_xoff(),
   .grp_d_tx_pfc_xoff(),
