...
input i_reset, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_0_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_1_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_2_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_3_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_4_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_5_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_6_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_7_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_8_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_9_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_10_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_11_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_12_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_13_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_14_if, 
mby_mem_gms_rx_uc_rf_shell_16x176_func_if.rx_uc_mem mem_rx_uc_15_if, 
//Input List
input                   MEM_POD_PTR_0_CFG_reg_sel,                
input                   MEM_POD_PTR_0_STATUS_reg_sel,             
input                   MEM_POD_PTR_1_CFG_reg_sel,                
input                   MEM_POD_PTR_1_STATUS_reg_sel,             
input                   MEM_POD_PTR_2_CFG_reg_sel,                
input                   MEM_POD_PTR_2_STATUS_reg_sel,             
input                   MEM_POD_PTR_3_CFG_reg_sel,                
input                   MEM_POD_PTR_3_STATUS_reg_sel,             
input                   MEM_POINTERS_0_CFG_reg_sel,               
input                   MEM_POINTERS_0_STATUS_reg_sel,            
input                   MEM_POINTERS_1_CFG_reg_sel,               
input                   MEM_POINTERS_1_STATUS_reg_sel,            
input                   MEM_POINTERS_2_CFG_reg_sel,               
input                   MEM_POINTERS_2_STATUS_reg_sel,            
input                   MEM_POINTERS_3_CFG_reg_sel,               
input                   MEM_POINTERS_3_STATUS_reg_sel,            
input                   MEM_POINTERS_4_CFG_reg_sel,               
input                   MEM_POINTERS_4_STATUS_reg_sel,            
input                   MEM_POINTERS_5_CFG_reg_sel,               
input                   MEM_POINTERS_5_STATUS_reg_sel,            
input                   MEM_POINTERS_6_CFG_reg_sel,               
input                   MEM_POINTERS_6_STATUS_reg_sel,            
input                   MEM_POINTERS_7_CFG_reg_sel,               
input                   MEM_POINTERS_7_STATUS_reg_sel,            
input                   cclk,                                     
...
input                   mclk,                                     
input           [10:0]  mem_pod_ptr_0_adr,                        
input                   mem_pod_ptr_0_mem_ls_enter,               
input                   mem_pod_ptr_0_rd_en,                      
input           [29:0]  mem_pod_ptr_0_wr_data,                    
input                   mem_pod_ptr_0_wr_en,                      
input           [10:0]  mem_pod_ptr_1_adr,                        
input                   mem_pod_ptr_1_mem_ls_enter,               
input                   mem_pod_ptr_1_rd_en,                      
input           [29:0]  mem_pod_ptr_1_wr_data,                    
input                   mem_pod_ptr_1_wr_en,                      
input           [10:0]  mem_pod_ptr_2_adr,                        
input                   mem_pod_ptr_2_mem_ls_enter,               
input                   mem_pod_ptr_2_rd_en,                      
input           [29:0]  mem_pod_ptr_2_wr_data,                    
input                   mem_pod_ptr_2_wr_en,                      
input           [10:0]  mem_pod_ptr_3_adr,                        
input                   mem_pod_ptr_3_mem_ls_enter,               
input                   mem_pod_ptr_3_rd_en,                      
input           [29:0]  mem_pod_ptr_3_wr_data,                    
input                   mem_pod_ptr_3_wr_en,                      
input            [9:0]  mem_pointers_0_adr,                       
input                   mem_pointers_0_mem_ls_enter,              
input                   mem_pointers_0_rd_en,                     
input           [15:0]  mem_pointers_0_wr_bwe,                    
input         [2207:0]  mem_pointers_0_wr_data,                   
input                   mem_pointers_0_wr_en,                     
input            [9:0]  mem_pointers_1_adr,                       
input                   mem_pointers_1_mem_ls_enter,              
input                   mem_pointers_1_rd_en,                     
input           [15:0]  mem_pointers_1_wr_bwe,                    
input         [2207:0]  mem_pointers_1_wr_data,                   
input                   mem_pointers_1_wr_en,                     
input            [9:0]  mem_pointers_2_adr,                       
input                   mem_pointers_2_mem_ls_enter,              
input                   mem_pointers_2_rd_en,                     
input           [15:0]  mem_pointers_2_wr_bwe,                    
input         [2207:0]  mem_pointers_2_wr_data,                   
input                   mem_pointers_2_wr_en,                     
input            [9:0]  mem_pointers_3_adr,                       
input                   mem_pointers_3_mem_ls_enter,              
input                   mem_pointers_3_rd_en,                     
input           [15:0]  mem_pointers_3_wr_bwe,                    
input         [2207:0]  mem_pointers_3_wr_data,                   
input                   mem_pointers_3_wr_en,                     
input            [9:0]  mem_pointers_4_adr,                       
input                   mem_pointers_4_mem_ls_enter,              
input                   mem_pointers_4_rd_en,                     
input           [15:0]  mem_pointers_4_wr_bwe,                    
input         [2207:0]  mem_pointers_4_wr_data,                   
input                   mem_pointers_4_wr_en,                     
input            [9:0]  mem_pointers_5_adr,                       
input                   mem_pointers_5_mem_ls_enter,              
input                   mem_pointers_5_rd_en,                     
input           [15:0]  mem_pointers_5_wr_bwe,                    
input         [2207:0]  mem_pointers_5_wr_data,                   
input                   mem_pointers_5_wr_en,                     
input            [9:0]  mem_pointers_6_adr,                       
input                   mem_pointers_6_mem_ls_enter,              
input                   mem_pointers_6_rd_en,                     
input           [15:0]  mem_pointers_6_wr_bwe,                    
input         [2207:0]  mem_pointers_6_wr_data,                   
input                   mem_pointers_6_wr_en,                     
input            [9:0]  mem_pointers_7_adr,                       
input                   mem_pointers_7_mem_ls_enter,              
input                   mem_pointers_7_rd_en,                     
input           [15:0]  mem_pointers_7_wr_bwe,                    
input         [2207:0]  mem_pointers_7_wr_data,                   
input                   mem_pointers_7_wr_en,                     

//Output List
output                  aary_pwren_b_sram,                        
output                  mem_pod_ptr_0_ecc_uncor_err,              
output                  mem_pod_ptr_0_init_done,                  
output          [29:0]  mem_pod_ptr_0_rd_data,                    
output                  mem_pod_ptr_0_rd_valid,                   
output                  mem_pod_ptr_1_ecc_uncor_err,              
output                  mem_pod_ptr_1_init_done,                  
output          [29:0]  mem_pod_ptr_1_rd_data,                    
output                  mem_pod_ptr_1_rd_valid,                   
output                  mem_pod_ptr_2_ecc_uncor_err,              
output                  mem_pod_ptr_2_init_done,                  
output          [29:0]  mem_pod_ptr_2_rd_data,                    
output                  mem_pod_ptr_2_rd_valid,                   
output                  mem_pod_ptr_3_ecc_uncor_err,              
output                  mem_pod_ptr_3_init_done,                  
output          [29:0]  mem_pod_ptr_3_rd_data,                    
output                  mem_pod_ptr_3_rd_valid,                   
output                  mem_pointers_0_ecc_uncor_err,             
output                  mem_pointers_0_init_done,                 
output        [2207:0]  mem_pointers_0_rd_data,                   
output                  mem_pointers_0_rd_valid,                  
output                  mem_pointers_1_ecc_uncor_err,             
output                  mem_pointers_1_init_done,                 
output        [2207:0]  mem_pointers_1_rd_data,                   
output                  mem_pointers_1_rd_valid,                  
output                  mem_pointers_2_ecc_uncor_err,             
output                  mem_pointers_2_init_done,                 
output        [2207:0]  mem_pointers_2_rd_data,                   
output                  mem_pointers_2_rd_valid,                  
output                  mem_pointers_3_ecc_uncor_err,             
output                  mem_pointers_3_init_done,                 
output        [2207:0]  mem_pointers_3_rd_data,                   
output                  mem_pointers_3_rd_valid,                  
output                  mem_pointers_4_ecc_uncor_err,             
output                  mem_pointers_4_init_done,                 
output        [2207:0]  mem_pointers_4_rd_data,                   
output                  mem_pointers_4_rd_valid,                  
output                  mem_pointers_5_ecc_uncor_err,             
output                  mem_pointers_5_init_done,                 
output        [2207:0]  mem_pointers_5_rd_data,                   
output                  mem_pointers_5_rd_valid,                  
output                  mem_pointers_6_ecc_uncor_err,             
output                  mem_pointers_6_init_done,                 
output        [2207:0]  mem_pointers_6_rd_data,                   
output                  mem_pointers_6_rd_valid,                  
output                  mem_pointers_7_ecc_uncor_err,             
output                  mem_pointers_7_init_done,                 
output        [2207:0]  mem_pointers_7_rd_data,                   
output                  mem_pointers_7_rd_valid                   
);
...
/* input  logic           */ .MEM_POD_PTR_0_CFG_reg_sel     (MEM_POD_PTR_0_CFG_reg_sel),               
/* input  logic           */ .MEM_POD_PTR_0_STATUS_reg_sel  (MEM_POD_PTR_0_STATUS_reg_sel),            
/* input  logic           */ .MEM_POD_PTR_1_CFG_reg_sel     (MEM_POD_PTR_1_CFG_reg_sel),               
/* input  logic           */ .MEM_POD_PTR_1_STATUS_reg_sel  (MEM_POD_PTR_1_STATUS_reg_sel),            
/* input  logic           */ .MEM_POD_PTR_2_CFG_reg_sel     (MEM_POD_PTR_2_CFG_reg_sel),               
/* input  logic           */ .MEM_POD_PTR_2_STATUS_reg_sel  (MEM_POD_PTR_2_STATUS_reg_sel),            
/* input  logic           */ .MEM_POD_PTR_3_CFG_reg_sel     (MEM_POD_PTR_3_CFG_reg_sel),               
/* input  logic           */ .MEM_POD_PTR_3_STATUS_reg_sel  (MEM_POD_PTR_3_STATUS_reg_sel),            
/* input  logic           */ .MEM_POINTERS_0_CFG_reg_sel    (MEM_POINTERS_0_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_0_STATUS_reg_sel (MEM_POINTERS_0_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_1_CFG_reg_sel    (MEM_POINTERS_1_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_1_STATUS_reg_sel (MEM_POINTERS_1_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_2_CFG_reg_sel    (MEM_POINTERS_2_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_2_STATUS_reg_sel (MEM_POINTERS_2_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_3_CFG_reg_sel    (MEM_POINTERS_3_CFG_reg_sel),              
...
/* input  logic           */ .MEM_POINTERS_3_STATUS_reg_sel (MEM_POINTERS_3_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_4_CFG_reg_sel    (MEM_POINTERS_4_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_4_STATUS_reg_sel (MEM_POINTERS_4_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_5_CFG_reg_sel    (MEM_POINTERS_5_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_5_STATUS_reg_sel (MEM_POINTERS_5_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_6_CFG_reg_sel    (MEM_POINTERS_6_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_6_STATUS_reg_sel (MEM_POINTERS_6_STATUS_reg_sel),           
/* input  logic           */ .MEM_POINTERS_7_CFG_reg_sel    (MEM_POINTERS_7_CFG_reg_sel),              
/* input  logic           */ .MEM_POINTERS_7_STATUS_reg_sel (MEM_POINTERS_7_STATUS_reg_sel),           
...
/* input  logic    [10:0] */ .mem_pod_ptr_0_adr             (mem_pod_ptr_0_adr),                       
/* input  logic           */ .mem_pod_ptr_0_mem_ls_enter    (mem_pod_ptr_0_mem_ls_enter),              
/* input  logic           */ .mem_pod_ptr_0_rd_en           (mem_pod_ptr_0_rd_en),                     
/* input  logic    [29:0] */ .mem_pod_ptr_0_wr_data         (mem_pod_ptr_0_wr_data),                   
/* input  logic           */ .mem_pod_ptr_0_wr_en           (mem_pod_ptr_0_wr_en),                     
/* input  logic    [10:0] */ .mem_pod_ptr_1_adr             (mem_pod_ptr_1_adr),                       
/* input  logic           */ .mem_pod_ptr_1_mem_ls_enter    (mem_pod_ptr_1_mem_ls_enter),              
/* input  logic           */ .mem_pod_ptr_1_rd_en           (mem_pod_ptr_1_rd_en),                     
/* input  logic    [29:0] */ .mem_pod_ptr_1_wr_data         (mem_pod_ptr_1_wr_data),                   
/* input  logic           */ .mem_pod_ptr_1_wr_en           (mem_pod_ptr_1_wr_en),                     
/* input  logic    [10:0] */ .mem_pod_ptr_2_adr             (mem_pod_ptr_2_adr),                       
/* input  logic           */ .mem_pod_ptr_2_mem_ls_enter    (mem_pod_ptr_2_mem_ls_enter),              
/* input  logic           */ .mem_pod_ptr_2_rd_en           (mem_pod_ptr_2_rd_en),                     
/* input  logic    [29:0] */ .mem_pod_ptr_2_wr_data         (mem_pod_ptr_2_wr_data),                   
/* input  logic           */ .mem_pod_ptr_2_wr_en           (mem_pod_ptr_2_wr_en),                     
/* input  logic    [10:0] */ .mem_pod_ptr_3_adr             (mem_pod_ptr_3_adr),                       
/* input  logic           */ .mem_pod_ptr_3_mem_ls_enter    (mem_pod_ptr_3_mem_ls_enter),              
/* input  logic           */ .mem_pod_ptr_3_rd_en           (mem_pod_ptr_3_rd_en),                     
/* input  logic    [29:0] */ .mem_pod_ptr_3_wr_data         (mem_pod_ptr_3_wr_data),                   
/* input  logic           */ .mem_pod_ptr_3_wr_en           (mem_pod_ptr_3_wr_en),                     
/* input  logic     [9:0] */ .mem_pointers_0_adr            (mem_pointers_0_adr),                      
/* input  logic           */ .mem_pointers_0_mem_ls_enter   (mem_pointers_0_mem_ls_enter),             
/* input  logic           */ .mem_pointers_0_rd_en          (mem_pointers_0_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_0_wr_bwe         (mem_pointers_0_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_0_wr_data        (mem_pointers_0_wr_data),                  
/* input  logic           */ .mem_pointers_0_wr_en          (mem_pointers_0_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_1_adr            (mem_pointers_1_adr),                      
/* input  logic           */ .mem_pointers_1_mem_ls_enter   (mem_pointers_1_mem_ls_enter),             
/* input  logic           */ .mem_pointers_1_rd_en          (mem_pointers_1_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_1_wr_bwe         (mem_pointers_1_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_1_wr_data        (mem_pointers_1_wr_data),                  
/* input  logic           */ .mem_pointers_1_wr_en          (mem_pointers_1_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_2_adr            (mem_pointers_2_adr),                      
/* input  logic           */ .mem_pointers_2_mem_ls_enter   (mem_pointers_2_mem_ls_enter),             
/* input  logic           */ .mem_pointers_2_rd_en          (mem_pointers_2_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_2_wr_bwe         (mem_pointers_2_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_2_wr_data        (mem_pointers_2_wr_data),                  
/* input  logic           */ .mem_pointers_2_wr_en          (mem_pointers_2_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_3_adr            (mem_pointers_3_adr),                      
/* input  logic           */ .mem_pointers_3_mem_ls_enter   (mem_pointers_3_mem_ls_enter),             
/* input  logic           */ .mem_pointers_3_rd_en          (mem_pointers_3_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_3_wr_bwe         (mem_pointers_3_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_3_wr_data        (mem_pointers_3_wr_data),                  
/* input  logic           */ .mem_pointers_3_wr_en          (mem_pointers_3_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_4_adr            (mem_pointers_4_adr),                      
/* input  logic           */ .mem_pointers_4_mem_ls_enter   (mem_pointers_4_mem_ls_enter),             
/* input  logic           */ .mem_pointers_4_rd_en          (mem_pointers_4_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_4_wr_bwe         (mem_pointers_4_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_4_wr_data        (mem_pointers_4_wr_data),                  
/* input  logic           */ .mem_pointers_4_wr_en          (mem_pointers_4_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_5_adr            (mem_pointers_5_adr),                      
/* input  logic           */ .mem_pointers_5_mem_ls_enter   (mem_pointers_5_mem_ls_enter),             
/* input  logic           */ .mem_pointers_5_rd_en          (mem_pointers_5_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_5_wr_bwe         (mem_pointers_5_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_5_wr_data        (mem_pointers_5_wr_data),                  
/* input  logic           */ .mem_pointers_5_wr_en          (mem_pointers_5_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_6_adr            (mem_pointers_6_adr),                      
/* input  logic           */ .mem_pointers_6_mem_ls_enter   (mem_pointers_6_mem_ls_enter),             
/* input  logic           */ .mem_pointers_6_rd_en          (mem_pointers_6_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_6_wr_bwe         (mem_pointers_6_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_6_wr_data        (mem_pointers_6_wr_data),                  
/* input  logic           */ .mem_pointers_6_wr_en          (mem_pointers_6_wr_en),                    
/* input  logic     [9:0] */ .mem_pointers_7_adr            (mem_pointers_7_adr),                      
/* input  logic           */ .mem_pointers_7_mem_ls_enter   (mem_pointers_7_mem_ls_enter),             
/* input  logic           */ .mem_pointers_7_rd_en          (mem_pointers_7_rd_en),                    
/* input  logic    [15:0] */ .mem_pointers_7_wr_bwe         (mem_pointers_7_wr_bwe),                   
/* input  logic  [2207:0] */ .mem_pointers_7_wr_data        (mem_pointers_7_wr_data),                  
/* input  logic           */ .mem_pointers_7_wr_en          (mem_pointers_7_wr_en),                    
...
/* output logic           */ .mem_pod_ptr_0_ecc_uncor_err   (mem_pod_ptr_0_ecc_uncor_err),             
/* output logic           */ .mem_pod_ptr_0_init_done       (mem_pod_ptr_0_init_done),                 
/* output logic    [29:0] */ .mem_pod_ptr_0_rd_data         (mem_pod_ptr_0_rd_data),                   
/* output logic           */ .mem_pod_ptr_0_rd_valid        (mem_pod_ptr_0_rd_valid),                  
/* output logic           */ .mem_pod_ptr_1_ecc_uncor_err   (mem_pod_ptr_1_ecc_uncor_err),             
/* output logic           */ .mem_pod_ptr_1_init_done       (mem_pod_ptr_1_init_done),                 
/* output logic    [29:0] */ .mem_pod_ptr_1_rd_data         (mem_pod_ptr_1_rd_data),                   
/* output logic           */ .mem_pod_ptr_1_rd_valid        (mem_pod_ptr_1_rd_valid),                  
/* output logic           */ .mem_pod_ptr_2_ecc_uncor_err   (mem_pod_ptr_2_ecc_uncor_err),             
/* output logic           */ .mem_pod_ptr_2_init_done       (mem_pod_ptr_2_init_done),                 
/* output logic    [29:0] */ .mem_pod_ptr_2_rd_data         (mem_pod_ptr_2_rd_data),                   
/* output logic           */ .mem_pod_ptr_2_rd_valid        (mem_pod_ptr_2_rd_valid),                  
/* output logic           */ .mem_pod_ptr_3_ecc_uncor_err   (mem_pod_ptr_3_ecc_uncor_err),             
/* output logic           */ .mem_pod_ptr_3_init_done       (mem_pod_ptr_3_init_done),                 
/* output logic    [29:0] */ .mem_pod_ptr_3_rd_data         (mem_pod_ptr_3_rd_data),                   
/* output logic           */ .mem_pod_ptr_3_rd_valid        (mem_pod_ptr_3_rd_valid),                  
/* output logic           */ .mem_pointers_0_ecc_uncor_err  (mem_pointers_0_ecc_uncor_err),            
/* output logic           */ .mem_pointers_0_init_done      (mem_pointers_0_init_done),                
/* output logic  [2207:0] */ .mem_pointers_0_rd_data        (mem_pointers_0_rd_data),                  
/* output logic           */ .mem_pointers_0_rd_valid       (mem_pointers_0_rd_valid),                 
/* output logic           */ .mem_pointers_1_ecc_uncor_err  (mem_pointers_1_ecc_uncor_err),            
/* output logic           */ .mem_pointers_1_init_done      (mem_pointers_1_init_done),                
/* output logic  [2207:0] */ .mem_pointers_1_rd_data        (mem_pointers_1_rd_data),                  
/* output logic           */ .mem_pointers_1_rd_valid       (mem_pointers_1_rd_valid),                 
/* output logic           */ .mem_pointers_2_ecc_uncor_err  (mem_pointers_2_ecc_uncor_err),            
/* output logic           */ .mem_pointers_2_init_done      (mem_pointers_2_init_done),                
/* output logic  [2207:0] */ .mem_pointers_2_rd_data        (mem_pointers_2_rd_data),                  
/* output logic           */ .mem_pointers_2_rd_valid       (mem_pointers_2_rd_valid),                 
/* output logic           */ .mem_pointers_3_ecc_uncor_err  (mem_pointers_3_ecc_uncor_err),            
/* output logic           */ .mem_pointers_3_init_done      (mem_pointers_3_init_done),                
/* output logic  [2207:0] */ .mem_pointers_3_rd_data        (mem_pointers_3_rd_data),                  
/* output logic           */ .mem_pointers_3_rd_valid       (mem_pointers_3_rd_valid),                 
/* output logic           */ .mem_pointers_4_ecc_uncor_err  (mem_pointers_4_ecc_uncor_err),            
/* output logic           */ .mem_pointers_4_init_done      (mem_pointers_4_init_done),                
/* output logic  [2207:0] */ .mem_pointers_4_rd_data        (mem_pointers_4_rd_data),                  
/* output logic           */ .mem_pointers_4_rd_valid       (mem_pointers_4_rd_valid),                 
/* output logic           */ .mem_pointers_5_ecc_uncor_err  (mem_pointers_5_ecc_uncor_err),            
/* output logic           */ .mem_pointers_5_init_done      (mem_pointers_5_init_done),                
/* output logic  [2207:0] */ .mem_pointers_5_rd_data        (mem_pointers_5_rd_data),                  
/* output logic           */ .mem_pointers_5_rd_valid       (mem_pointers_5_rd_valid),                 
/* output logic           */ .mem_pointers_6_ecc_uncor_err  (mem_pointers_6_ecc_uncor_err),            
/* output logic           */ .mem_pointers_6_init_done      (mem_pointers_6_init_done),                
/* output logic  [2207:0] */ .mem_pointers_6_rd_data        (mem_pointers_6_rd_data),                  
/* output logic           */ .mem_pointers_6_rd_valid       (mem_pointers_6_rd_valid),                 
/* output logic           */ .mem_pointers_7_ecc_uncor_err  (mem_pointers_7_ecc_uncor_err),            
/* output logic           */ .mem_pointers_7_init_done      (mem_pointers_7_init_done),                
/* output logic  [2207:0] */ .mem_pointers_7_rd_data        (mem_pointers_7_rd_data),                  
/* output logic           */ .mem_pointers_7_rd_valid       (mem_pointers_7_rd_valid),                 
