...
typedef struct _fm_portAttrEntry
{
    ...
    /* The FM_PORT_XXX attribute put in " " (i.e. "FM_PORT_MASK") to have it
...
typedef struct _fm_portAttribute
{
    ...
    fm_uint32     autoNegPartnerBasePage;
...
struct _fm_port
{
    ...
    /**************************************************
     * Glort table management fields. (FM4000/FM6000)
     **************************************************/
    ...
    /* The index in the switch LAG table (fm_lag_info.lag) of the 
    ...
    /* Indicates whether an ACL is active on this port. */
    /* FIXME: This is FM2000-specific... does it really belong here? */
    fm_bool                aclAttached;
