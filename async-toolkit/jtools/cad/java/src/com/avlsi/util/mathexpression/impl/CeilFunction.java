...
/**
   Default implmentation of ceiling function.
 */
public class CeilFunction extends DoubleOperatorCommon {

    protected MathExpression m_x;

    /**
       Construct a call to the ceiling funciton.
       @param x Expression to calculate the ceiling of.
     */
    public CeilFunction( MathExpression x ) {
	m_x = x;
    }
	...
	if ( isConstant() ) {
	    ...
	    ret = new CeilFunction( m_x.evaluate( varBindings ) );
	}
	if ( ret.isConstant() ) {
	    try {
	...
	return java.lang.Math.ceil( m_x.getConstantValue() );
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CeilFunction) {
            CeilFunction o = (CeilFunction) obj;
