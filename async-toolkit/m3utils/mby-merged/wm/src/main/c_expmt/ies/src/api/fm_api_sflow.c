...
fm_status fmCreateSFlow(fm_int sw, fm_int sFlowId, fm_sFlowType sFlowType)
{
    ...
    FM_LOG_ENTRY_API(FM_LOG_CAT_SFLOW, "sw=%d, sFlowId=%d sFlowType=%d\n", 
                     sw, 
                     sFlowId, 
                     sFlowType);
                              ...
                              fm_bool         * isPktSFlowLogged)
{
    ...
    FM_API_CALL_FAMILY(err, switchPtr->CheckSFlowLogging, sw, pktEvent, isPktSFlowLogged);
