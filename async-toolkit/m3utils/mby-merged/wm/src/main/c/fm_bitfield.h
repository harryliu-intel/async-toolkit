 ...
 *                 position constants in fm4000_api_regs_int.h
 *
 * INTEL CONFIDENTIAL
...
/** Extract an unnamed field of 64 or fewer bits from a >64-bit value. */
#define FM_ARRAY_GET_UNNAMED_FIELD64(array, start, len) \
    fmMultiWordBitfieldGet64((array), (start) + (len) - 1, (start))
