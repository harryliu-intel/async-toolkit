...
/**
 * <p> An interface for static debugging for the tsim package. </p>
 *
 * <p> Set this variable to "true" to compile in all debugging
 * code. </p>
 *
 * <p> Once we determine which other primary packages tsim depends
 * upon, we will augment this definition appropriately.  E.g., if tsim
...
public interface TSimDebug {

    boolean DEBUG = false;

    boolean VERBOSE = false;

} // end of interface TSimDebug
