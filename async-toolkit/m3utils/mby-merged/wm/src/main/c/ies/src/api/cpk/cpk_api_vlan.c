...
/*****************************************************************************/
/** cpkAllocateVlanTableDataStructures
 * \ingroup intVlan
 *
 ...
 *
 *****************************************************************************/
fm_status cpkAllocateVlanTableDataStructures(fm_switch *switchPtr)
{
    ...
    /* TODO Allocation of the CPK specific VLAN entry must be added here. */

    FM_LOG_EXIT(FM_LOG_CAT_VLAN, FM_OK);

}   /* end cpkAllocateVlanTableDataStructures */
