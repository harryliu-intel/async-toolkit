...
/*****************************************************************************
 * File:            fm_std_kernel.h
 * Creation Date:   2005
 * Description:     Architecture-specific definitions for a big-endian MPC8245
 *                  and MPC8541
 *
 ...
 *
 ****************************************************************************/
#ifndef __FM_FM_STD_KERNEL_H
#define __FM_FM_STD_KERNEL_H
...
/* Doxygen control: Group the typdef's below. */
/** \ingroup typeStd
 * @{ */
