...
/**
 * Right shift expression, represents <code> a &gt;&gt; b </code>.
 *
 * @author Jesse Rosenstock
 * @version $Revision$ $Date$
 **/
public class RightShiftExpression extends AbstractBinaryExpression {
     ...
     **/
    public RightShiftExpression(final ExpressionInterface left,
