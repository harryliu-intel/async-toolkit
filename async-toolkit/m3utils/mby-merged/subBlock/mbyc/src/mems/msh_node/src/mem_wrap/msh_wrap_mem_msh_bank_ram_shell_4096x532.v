...
//////////////////////////////////////////////////////////////////////
`include        "msh_mem.def"
module  msh_wrap_mem_msh_bank_ram_shell_4096x532 #(
...
// That would ensure Tactive and Twake  are maintained. Twake is given in lib file to insure that all the internal array power rails are fully charged up prior memory access
        ...
        logic   [532-1:0]       wr_data_full;
        assign                  wr_data_full    = wr_data;
        logic   [532-1:0]       ram_row_wr_data;
        always_comb begin
        ...
        logic   [133-1:0]       ram_wr_data_col[4-1:0];
        always_comb begin
        ...
        logic   [4-1:0] ram_row_wr_en[1-1:0];
        always_comb begin
                ram_row_wr_en[0] = {4{1'b0}};
                ram_row_wr_en[0][4-1:0] =  ram_row_sel[0] ? {{4{wr_en_full[0]}}} : 4'd0;
        end
        logic   [1-1:0]         ram_col_wr_en[1-1:0][4-1:0];
        ...
        logic   [133-1:0]       ram_rd_data_col[1-1:0][4-1:0];
        logic   [532-1:0]       ram_rd_data_row;
        always_comb begin
                for (int i = 0; i < 4; i = i + 1) begin
        ...
        // EBBs Instantiation
                ...
                logic           [4-1:0] ram_fary_pwren_b;
                logic           [4-1:0] ram_aary_pwren_b;
                logic           [4-1:0] ram_aary_pwren_b_last;
                ...
                assign                  aary_pwren_b_sram       = ram_aary_pwren_b_last[4-1];
                ...
                wire    [133-1:0]              ram_row_0_col_1_data_in     = ram_wr_data_col[1][133-1:0];
                wire    [133-1:0]              ram_row_0_col_1_data_out;
                ...
                logic                           ram_row_0_col_1_pwren_b_out_inv; 
                assign ram_row_0_col_1_pwren_b_out = 0;// ~ram_row_0_col_1_pwren_b_out_inv; 
                
                
                  assign ram_aary_pwren_b[1] = 0;// ram_row_0_col_1_pwren_b_out; 
                ...
                `endif
                          ...
                          .CLK       (ram_row_0_col_1_clk), //       input   logic                                                 
                          .ADR       (ram_row_0_col_1_adr), //       input   logic   [MEM_ADR_WIDTH-1:0]                           
                          .ME        (1'b1), //       input   logic                                                 
                          .WE        (ram_row_0_col_1_wr_en), //       input   logic   [MEM_WE_WIDTH-1:0]                            
                          .D         (ram_row_0_col_1_data_in), //       input   logic   [      MEM_WIDTH-1:0]                         
                          .Q         (ram_row_0_col_1_data_out), //       output  logic   [      MEM_WIDTH-1:0]                         
                ...
                generate
                        if (MEM_PST_EBB_SAMPLE == 1) begin: PST_EBB_SAMPLE_DATA_1
                                logic    [133-1:0]              ram_row_0_col_1_data_out_s;
                                always_ff @(posedge clk) begin
                ...
                wire    [133-1:0]              ram_row_0_col_2_data_in     = ram_wr_data_col[2][133-1:0];
                wire    [133-1:0]              ram_row_0_col_2_data_out;
                ...
                logic                           ram_row_0_col_2_pwren_b_out_inv; 
                assign ram_row_0_col_2_pwren_b_out = 0;// ~ram_row_0_col_2_pwren_b_out_inv; 
                
                
                  assign ram_aary_pwren_b[2] = 0;// ram_row_0_col_2_pwren_b_out; 
                ...
                `endif
                          ...
                          .CLK       (ram_row_0_col_2_clk), //       input   logic                                                 
                          .ADR       (ram_row_0_col_2_adr), //       input   logic   [MEM_ADR_WIDTH-1:0]                           
                          .ME        (1'b1), //       input   logic                                                 
                          .WE        (ram_row_0_col_2_wr_en), //       input   logic   [MEM_WE_WIDTH-1:0]                            
                          .D         (ram_row_0_col_2_data_in), //       input   logic   [      MEM_WIDTH-1:0]                         
                          .Q         (ram_row_0_col_2_data_out), //       output  logic   [      MEM_WIDTH-1:0]                         
                ...
                generate
                        if (MEM_PST_EBB_SAMPLE == 1) begin: PST_EBB_SAMPLE_DATA_2
                                logic    [133-1:0]              ram_row_0_col_2_data_out_s;
                                always_ff @(posedge clk) begin
                ...
                wire    [133-1:0]              ram_row_0_col_3_data_in     = ram_wr_data_col[3][133-1:0];
                wire    [133-1:0]              ram_row_0_col_3_data_out;
                ...
                logic                           ram_row_0_col_3_pwren_b_out_inv; 
                assign ram_row_0_col_3_pwren_b_out = 0;// ~ram_row_0_col_3_pwren_b_out_inv; 
                
                
                  assign ram_aary_pwren_b[3] = 0;// ram_row_0_col_3_pwren_b_out; 
                ...
                `endif
                          ...
                          .CLK       (ram_row_0_col_3_clk), //       input   logic                                                 
                          .ADR       (ram_row_0_col_3_adr), //       input   logic   [MEM_ADR_WIDTH-1:0]                           
                          .ME        (1'b1), //       input   logic                                                 
                          .WE        (ram_row_0_col_3_wr_en), //       input   logic   [MEM_WE_WIDTH-1:0]                            
                          .D         (ram_row_0_col_3_data_in), //       input   logic   [      MEM_WIDTH-1:0]                         
                          .Q         (ram_row_0_col_3_data_out), //       output  logic   [      MEM_WIDTH-1:0]                         
                ...
                generate
                        if (MEM_PST_EBB_SAMPLE == 1) begin: PST_EBB_SAMPLE_DATA_3
                                logic    [133-1:0]              ram_row_0_col_3_data_out_s;
                                always_ff @(posedge clk) begin
...
////////////////////////////////////////////////////////////////////////
        ...
        assign          rd_valid                        = rd_en_delay[MEM_DELAY];
        generate
                if (MEM_PST_EBB_SAMPLE == 1) begin: PST_EBB_SAMPLE_DATA3
                ...
                else begin: NO_PST_EBB_SAMPLE_DATA3
...
parameter           MEM_INIT_VALUE_T = 532'h0 ; 
parameter       MEM_NUM_ROW = 1; 
parameter       MEM_NUM_COL = 4; 
parameter       MEM_TOTAL_W = 532; 
    ...
    temp_behave_mem_ext_data_folded[k*MEM_TOTAL_W +: MEM_TOTAL_W]  = behave_mem_acc.sram[i*MEM_FOLD_FACT +k];
         ...
         for (int j = 0;j < MEM_NUM_COL ; j = j+1) 
             case (j)
                                    ...
                                    1: begin
                                          ram_row_0_col_1.uut.mem_core_array[i%MEM_ROW_W] = temp_ph_mem_ext_data_folded[(j)*(MEM_COL_W)+:MEM_COL_W]        ;
                                    end
                                    2: begin
                                          ram_row_0_col_2.uut.mem_core_array[i%MEM_ROW_W] = temp_ph_mem_ext_data_folded[(j)*(MEM_COL_W)+:MEM_COL_W]        ;
                                    end
                                    3: begin
                                          ram_row_0_col_3.uut.mem_core_array[i%MEM_ROW_W] = temp_ph_mem_ext_data_folded[(j)*(MEM_COL_W)+:MEM_COL_W]        ;
                                    end
                                    default : begin
