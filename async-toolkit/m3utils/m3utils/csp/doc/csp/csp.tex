...
The peek, or {\em receive expression,} The peek is
\begin{Verbatim}[samepage=true]
   # IPort ?
\end{Verbatim}
...
\begin{tabular}{l}
  \verb!readHexInts   (path : string; n : integer; data : integer[]) : int! \\
\end{tabular}
...
\begin{tabular}{l}
  \verb!min   (x, y : integer) : int! \\
  \verb!max   (x, y : integer) : int! \\
\end{tabular}
...
\begin{tabular}{l}
  \verb!choose   (x : bool; y, z: integer) : int! \\
\end{tabular}
...
\begin{tabular}{l}
  \verb!log2   (x : integer) : int! \\
  \verb!log4   (x : integer) : int! \\
\end{tabular}
