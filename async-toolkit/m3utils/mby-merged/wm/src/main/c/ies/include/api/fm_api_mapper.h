...
typedef struct _fm_sourceMapperValue
{
    ...
    /** Mapped value of source port (4 bit field on FM4000
...
typedef struct _fm_protocolMapperValue
{
     ...
     *  3 bit field on FM4000 and a 4 bit field on FM6000. The 0 value is
     *  reserved for other non-mapped protocols.
     *  
     *  \chips  FM3000, FM4000, FM6000 */
...
typedef struct _fm_l4PortMapperValue
{
     ...
     *  the mapped value is set to 0 if there is no match.
     *  
     *  \chips  FM3000, FM4000, FM6000 */
