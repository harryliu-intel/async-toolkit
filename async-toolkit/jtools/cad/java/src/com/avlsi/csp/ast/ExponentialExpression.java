...
/**
 * Exponentail expression, represents <code> a ** b </code>.
 *
 * @author Jesse Rosenstock
 * @version $Revision$ $Date$
 **/
public class ExponentialExpression extends AbstractBinaryExpression {
     ...
     **/
    public ExponentialExpression(final ExpressionInterface left,
    ...
    public void accept(VisitorInterface v) throws VisitorException {
        v.visitExponentialExpression(this);
    }
