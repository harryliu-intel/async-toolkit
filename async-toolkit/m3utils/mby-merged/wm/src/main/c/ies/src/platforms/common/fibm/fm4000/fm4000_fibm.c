...
fm_status fm4000FibmEnableSlaveSwitch(fm_int slaveSw, fm_bool enable)
{
    ...
    FM_LOG_ENTRY(FM_LOG_CAT_FIBM,
                 "fm4000FibmEnableSlaveSwitch: slaveSw %d enable %d\n",
                 slaveSw, 
                 enable);
...
} /* end fm4000FibmEnableSlaveSwitch */




/*****************************************************************************/
/** fm4000FibmEnableMasterSwitch
 * \ingroup intSwitch
 *
...
fm_status fm4000FibmEnableMasterSwitch(fm_int sw, fm_bool enable)
{
    ...
    FM_LOG_ENTRY(FM_LOG_CAT_FIBM,
                 "fm4000FibmEnableMasterSwitch: sw %d enable %d\n", sw, enable);
    ...
    status = switchPtr->ReadUINT32(sw, FM4000_MSB_CFG, &val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);

    if (enable)
    {
        FM_SET_BIT(val32, FM4000_MSB_CFG, attachedCpu, 1);
        FM_SET_BIT(val32, FM4000_MSB_CFG, disableIbm, 0);
        FM_SET_BIT(val32, FM4000_MSB_CFG, ibmGlortEn, 0);
        FM_SET_BIT(val32, FM4000_MSB_CFG, interruptGlortEn, 0);
    }
    else
    {
        FM_SET_BIT(val32, FM4000_MSB_CFG, attachedCpu, 0);
        FM_SET_BIT(val32, FM4000_MSB_CFG, disableIbm, 1);
        FM_SET_BIT(val32, FM4000_MSB_CFG, ibmGlortEn, 1);
        FM_SET_BIT(val32, FM4000_MSB_CFG, interruptGlortEn, 1);
    }

    status = switchPtr->WriteUINT32(sw, FM4000_MSB_CFG, val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);
     ...
     */
    status = switchPtr->ReadUINT32(sw, FM4000_MSB_IBM_GLORT, &val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);
    val32  = FM4000_GLORT_FIBM(0);
    status = switchPtr->WriteUINT32(sw, FM4000_MSB_IBM_GLORT, val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);
    ...
    status = switchPtr->ReadUINT32(sw, FM4000_MSB_INT_FRAME, &val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);
    ...
    status = switchPtr->WriteUINT32(sw, FM4000_MSB_INT_FRAME, val32);
    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);
    ...
    FM_LOG_EXIT(FM_LOG_CAT_FIBM, FM_OK);
} /* end fm4000FibmEnableMasterSwitch */




/*****************************************************************************/
/** fm4000FibmAddSlaveSwitch
 * \ingroup intSwitch
 *
...
} /* end fm4000FibmAddSlaveSwitch */




/*****************************************************************************/
/** fm4000FibmRemoveSlaveSwitch
 * \ingroup intSwitch
 *
...
fm_status fm4000FibmRemoveSlaveSwitch(fm_int sw)
{
    ...
    FM_LOG_ENTRY(FM_LOG_CAT_FIBM,
                 "fm4000FibmRemoveSlaveSwitch: sw %d\n", sw);
...
} /* end fm4000FibmRemoveSlaveSwitch */




/*****************************************************************************/
/** fm4000FibmCreateFwdRuleMasterSwitch
 * \ingroup intSwitch
 *
...
} /* end fm4000FibmCreateFwdRuleMasterSwitch */




/*****************************************************************************/
/** fm4000FibmCreateFwdRuleSlaveSwitch
 * \ingroup intSwitch
 *
 * \desc            Function to create all neccessary forwarding rules on the
                                             ...
                                             fm_int *fwdRuleCnt)
{
    ...
    *fwdRuleCnt = 0;
     ...
     * switch
     */
    rule.glort       = FM4000_GLORT_FIBM(masterGlortBase);
    ...
    status = fmRegCacheWriteSingle1D ( slaveSw,
                                       &fm4000CacheGlortCam,
                                       &zero,
                                       FM4000_FIBM_CPU_CAM_INDEX,
                                       FALSE );

    FM_LOG_EXIT_ON_ERR(FM_LOG_CAT_FIBM, status);

    return FM_OK;
} /* end fm4000FibmCreateFwdRuleSlaveSwitch */
...
fm_int fm4000GetMaxFibmCmdLength(fm_int addr)
{
     ...
     */
    if ( (addr >= FM4000_HANDLER_BASE) &&
         (addr < (FM4000_HANDLER_BASE + FM4000_HANDLER_SIZE)) )
    {
        cmdMaxLen = 4;
    }
    else if ( (addr >= FM4000_MTABLE_BASE) &&
         (addr < (FM4000_MTABLE_BASE + FM4000_MTABLE_SIZE)) )
    {
        cmdMaxLen = 3;
    }
    else if ( (addr >= FM4000_STATS_BASE) &&
         (addr < (FM4000_STATS_BASE + FM4000_STATS_SIZE)) )
    {
        cmdMaxLen = 3;
    }

    return cmdMaxLen;
} /* end fm4000GetMaxFibmCmdLength */

/*****************************************************************************/
/** fm4000SetFibmSlaveEepromConfig
 * \ingroup intFibm
 *
 ...
 *
 *****************************************************************************/
fm_status fm4000SetFibmSlaveEepromConfig(fm_int localSw, 
                                         fm_int fibmPort, 
                                         fm_uint32 fibmGlort, 
                                         fm_uint32 fibmDstGlort)
{
    ...
    VALIDATE_AND_PROTECT_SWITCH(localSw);
    ...
    status = fmPlatformMapLogicalPortToPhysical(localSw, fibmPort, &sw, &physPort);
    FM_LOG_ABORT_ON_ERR(FM_LOG_CAT_FIBM, status);
...
fm_status fm4000FibmApplyNewConfig(fm_int sw)
{
    ...
    status = fm4000FibmEnableSlaveSwitch(sw, TRUE);
    FM_LOG_ABORT_ON_ERR(FM_LOG_CAT_FIBM, status);
