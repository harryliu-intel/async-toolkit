...
secant method familiar from high school math classes.  Yes we could use logarithms to invert the Poisson formula, also.)  We can now
...
\begin{equation}
  Y_{800/801} = 801 \, Y(800) - 800 \, Y(801)
\end{equation}
and the yield improvement is
\begin{equation}
  I_{800/801} = { 801 \, Y(800) - 800 \, Y(801) - Y(800) \over Y(800) }
