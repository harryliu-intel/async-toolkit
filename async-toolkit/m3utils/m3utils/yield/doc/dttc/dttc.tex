...
Poisson's formula and the Bose-Einstein formula, are special cases of
...
sophisticated method (\ref{eq:murphy}) already in 1964.  Big advances
...
Gamma-distribution statistics to the yield problem in 1973,
rediscovering the yield formula (\ref{eq:stapperyield}) that P\'olya
and Eggenberger had developed in 1923 for a problem in botany.
...
section~\ref{sec:general}.\footnote{We have also developed two more
  ...
  algorithm to discover the correct yield function.  This method is
