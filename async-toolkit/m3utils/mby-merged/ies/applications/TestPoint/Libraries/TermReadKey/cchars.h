...
XS(XS_Term__ReadKey_GetControlChars)
{
	...
	SP -= items;
	{
 	...
 	||ioctl(fileno(PerlIO_file),TIOCGETC,&s.s2)  
        ||ioctl(fileno(PerlIO_file),TIOCGLTC,&s.s3)  
			...
			EXTEND(sp,MAXCC*2);		
PUSHs(sv_2mortal(newSVpv(cc_names[0],strlen(cc_names[0])))); /* DISCARD */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_flushc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[1],strlen(cc_names[1])))); /* DSUSPEND */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_dsuspc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[2],strlen(cc_names[2])))); /* EOF */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_eofc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[3],strlen(cc_names[3])))); /* EOL */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_brkc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[4],strlen(cc_names[4])))); /* ERASE */
PUSHs(sv_2mortal(newSVpv(&s.s1.sg_erase,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[5],strlen(cc_names[5])))); /* ERASEWORD */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_werasc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[6],strlen(cc_names[6])))); /* INTERRUPT */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_intrc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[7],strlen(cc_names[7])))); /* KILL */
PUSHs(sv_2mortal(newSVpv(&s.s1.sg_kill,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[8],strlen(cc_names[8])))); /* QUIT */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_quitc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[9],strlen(cc_names[9])))); /* QUOTENEXT */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_lnextc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[10],strlen(cc_names[10])))); /* REPRINT */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_rprntc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[11],strlen(cc_names[11])))); /* START */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_startc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[12],strlen(cc_names[12])))); /* STOP */
PUSHs(sv_2mortal(newSVpv(&s.s2.t_stopc,1))); 	
PUSHs(sv_2mortal(newSVpv(cc_names[13],strlen(cc_names[13])))); /* SUSPEND */
PUSHs(sv_2mortal(newSVpv(&s.s3.t_suspc,1))); 	
...
XS(XS_Term__ReadKey_SetControlChars)
{
	...
	if (0) ;					
		...
		s.s3.t_flushc = value;		
	else if(strcmp(name,cc_names[1])==0) /* DSUSPEND */ 
		s.s3.t_dsuspc = value;		
	else if(strcmp(name,cc_names[2])==0) /* EOF */ 
		s.s2.t_eofc = value;		
	else if(strcmp(name,cc_names[3])==0) /* EOL */ 
		s.s2.t_brkc = value;		
	else if(strcmp(name,cc_names[4])==0) /* ERASE */ 
		s.s1.sg_erase = value;		
	else if(strcmp(name,cc_names[5])==0) /* ERASEWORD */ 
		s.s3.t_werasc = value;		
	else if(strcmp(name,cc_names[6])==0) /* INTERRUPT */ 
		s.s2.t_intrc = value;		
	else if(strcmp(name,cc_names[7])==0) /* KILL */ 
		s.s1.sg_kill = value;		
	else if(strcmp(name,cc_names[8])==0) /* QUIT */ 
		s.s2.t_quitc = value;		
	else if(strcmp(name,cc_names[9])==0) /* QUOTENEXT */ 
		s.s3.t_lnextc = value;		
	else if(strcmp(name,cc_names[10])==0) /* REPRINT */ 
		s.s3.t_rprntc = value;		
	else if(strcmp(name,cc_names[11])==0) /* START */ 
		s.s2.t_startc = value;		
	else if(strcmp(name,cc_names[12])==0) /* STOP */ 
		s.s2.t_stopc = value;		
	else if(strcmp(name,cc_names[13])==0) /* SUSPEND */ 
		s.s3.t_suspc = value;		
	else
		croak("Invalid control character passed to SetControlChars");
	        ...
	        ||ioctl(fileno(PerlIO_file),TIOCSETC,&s.s2) 
